var kobj_fn = 'kobj-static-20090423.js'; (function(){var _jQuery=window.jQuery,_$=window.$;var jQuery=window.jQuery=window.$=function(selector,context){return new jQuery.fn.init(selector,context);};var quickExpr=/^[^<]*(<(.|\s)+>)[^>]*$|^#(\w+)$/,isSimple=/^.[^:#\[\.]*$/,undefined;jQuery.fn=jQuery.prototype={init:function(selector,context){selector=selector||document;if(selector.nodeType){this[0]=selector;this.length=1;return this;}
...
KOBJ['data']=KOBJ['data']||{};KOBJ.proto='http://';KOBJ.init_host='init.kobj.net';KOBJ.eval_host='cs.kobj.net';KOBJ.callback_host='log.kobj.net';KOBJ.init=function(init_obj){$K.each(init_obj,function(k,v){KOBJ[k]=v;});};KOBJ.require=function(url){var r=document.createElement("script");r.src=url;r.type="text/javascript";var body=document.getElementsByTagName("body")[0];body.appendChild(r);};KOBJ.eval=function(params){if(!params.rids&&typeof(params.rids)!=='array'){return;}
