...
window['KOBJ'] = { name: "KRL Runtime Library",
    version: '1.0',
    copyright: "Portions of this file are part of the Kinetic Rules Engine (KRE). Copyright (C) 2007-2012 Kynetx, Inc. Licensed under: GNU Public License version 2 or later."
};
