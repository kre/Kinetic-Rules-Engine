// $ANTLR 3.2 Sep 23, 2009 12:02:23 RuleSet.g 2010-09-08 10:35:46
...
public class RuleSetParser extends Parser {
    ...
    // $ANTLR start "ruleset"
    // RuleSet.g:205:1: ruleset options {backtrack=false; } : RULE_SET rulesetname LEFT_CURL ( meta_block | dispatch_block | global_block | rule )* RIGHT_CURL EOF ;
    public final RuleSetParser.ruleset_return ruleset() throws RecognitionException {
        ...
        try {
            // RuleSet.g:216:3: ( RULE_SET rulesetname LEFT_CURL ( meta_block | dispatch_block | global_block | rule )* RIGHT_CURL EOF )
            // RuleSet.g:217:3: RULE_SET rulesetname LEFT_CURL ( meta_block | dispatch_block | global_block | rule )* RIGHT_CURL EOF
            {
            ...
            // RuleSet.g:219:4: ( meta_block | dispatch_block | global_block | rule )*
            loop1:
            do {
                int alt1=5;
                switch ( input.LA(1) ) {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // RuleSet.g:219:19: dispatch_block
            	    {
    ...
    // $ANTLR start "must_be"
    // RuleSet.g:224:1: must_be[String what] : v= VAR ;
    public final RuleSetParser.must_be_return must_be(String what) throws RecognitionException {
        ...
        try {
            // RuleSet.g:225:3: (v= VAR )
            // RuleSet.g:226:3: v= VAR
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:229:1: must_be_one[String[] what] : v= VAR ;
    public final RuleSetParser.must_be_one_return must_be_one(String[] what) throws RecognitionException {
        ...
        try {
            // RuleSet.g:230:3: (v= VAR )
            // RuleSet.g:231:3: v= VAR
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:234:2: rulesetname : ( VAR | INT );
    ...
    // RuleSet.g:244:2: rule_name : ( VAR | INT | OTHER_OPERATORS | LIKE | REPLACE | MATCH );
    public final RuleSetParser.rule_name_return rule_name() throws RecognitionException {
        ...
        try {
            // RuleSet.g:245:2: ( VAR | INT | OTHER_OPERATORS | LIKE | REPLACE | MATCH )
            // RuleSet.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "rule"
    // RuleSet.g:249:1: rule : must_be[\"rule\"] name= rule_name must_be[\"is\"] ait= must_be_one[sar(\"active\",\"inactive\",\"test\")] LEFT_CURL select= VAR (ptu= using | ptw= when ) (f= foreach )* (pb= pre_block )? ( SEMI )? (eb= emit_block )? ( SEMI )? ( action[actions_result] ( SEMI )? )* (cb= callbacks )? ( SEMI )? (postb= post_block )? ( SEMI )? RIGHT_CURL ;
    public final RuleSetParser.rule_return rule() throws RecognitionException {
        ...
        try {
            // RuleSet.g:256:3: ( must_be[\"rule\"] name= rule_name must_be[\"is\"] ait= must_be_one[sar(\"active\",\"inactive\",\"test\")] LEFT_CURL select= VAR (ptu= using | ptw= when ) (f= foreach )* (pb= pre_block )? ( SEMI )? (eb= emit_block )? ( SEMI )? ( action[actions_result] ( SEMI )? )* (cb= callbacks )? ( SEMI )? (postb= post_block )? ( SEMI )? RIGHT_CURL )
            // RuleSet.g:256:6: must_be[\"rule\"] name= rule_name must_be[\"is\"] ait= must_be_one[sar(\"active\",\"inactive\",\"test\")] LEFT_CURL select= VAR (ptu= using | ptw= when ) (f= foreach )* (pb= pre_block )? ( SEMI )? (eb= emit_block )? ( SEMI )? ( action[actions_result] ( SEMI )? )* (cb= callbacks )? ( SEMI )? (postb= post_block )? ( SEMI )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:262:60: (ptu= using | ptw= when )
            int alt2=2;
            ...
            // RuleSet.g:263:28: (eb= emit_block )?
            int alt6=2;
            ...
            // RuleSet.g:263:47: ( action[actions_result] ( SEMI )? )*
            loop9:
            do {
                int alt9=2;
                ...
                switch (alt9) {
            	case 1 :
            	    // RuleSet.g:263:48: action[actions_result] ( SEMI )?
            	    {
            ...
            // RuleSet.g:263:104: (postb= post_block )?
            int alt12=2;
    ...
    // RuleSet.g:316:1: post_block returns [HashMap result] : typ= must_be_one[sar(\"fired\",\"always\",\"notfired\")] LEFT_CURL p1= post_statement ( SEMI p2= post_statement )* ( SEMI )? RIGHT_CURL (alt= post_alternate )? ;
    public final RuleSetParser.post_block_return post_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:320:2: (typ= must_be_one[sar(\"fired\",\"always\",\"notfired\")] LEFT_CURL p1= post_statement ( SEMI p2= post_statement )* ( SEMI )? RIGHT_CURL (alt= post_alternate )? )
            // RuleSet.g:321:2: typ= must_be_one[sar(\"fired\",\"always\",\"notfired\")] LEFT_CURL p1= post_statement ( SEMI p2= post_statement )* ( SEMI )? RIGHT_CURL (alt= post_alternate )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:322:51: ( SEMI p2= post_statement )*
            loop14:
            do {
                int alt14=2;
                ...
                switch (alt14) {
            	case 1 :
            	    // RuleSet.g:322:52: SEMI p2= post_statement
            	    {
            ...
            // RuleSet.g:323:6: (alt= post_alternate )?
            int alt16=2;
    ...
    // RuleSet.g:337:1: post_alternate returns [ArrayList result] : must_be[\"else\"] LEFT_CURL (p= post_statement ( SEMI p1= post_statement )* )? ( SEMI )? RIGHT_CURL ;
    public final RuleSetParser.post_alternate_return post_alternate() throws RecognitionException {
        ...
        try {
            // RuleSet.g:341:2: ( must_be[\"else\"] LEFT_CURL (p= post_statement ( SEMI p1= post_statement )* )? ( SEMI )? RIGHT_CURL )
            // RuleSet.g:342:3: must_be[\"else\"] LEFT_CURL (p= post_statement ( SEMI p1= post_statement )* )? ( SEMI )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:342:29: (p= post_statement ( SEMI p1= post_statement )* )?
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // RuleSet.g:342:30: p= post_statement ( SEMI p1= post_statement )*
                    {
                    ...
                    // RuleSet.g:342:76: ( SEMI p1= post_statement )*
                    loop17:
                    do {
                        int alt17=2;
                        ...
                        switch (alt17) {
                    	case 1 :
                    	    // RuleSet.g:342:77: SEMI p1= post_statement
                    	    {
    ...
    // RuleSet.g:346:1: post_statement returns [HashMap result] : ( (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] ) ( IF ie= expr )? ) ;
    public final RuleSetParser.post_statement_return post_statement() throws RecognitionException {
        ...
        try {
            // RuleSet.g:347:2: ( ( (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] ) ( IF ie= expr )? ) )
            // RuleSet.g:347:4: ( (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] ) ( IF ie= expr )? )
            {
            root_0 = (Object)adaptor.nil();

            // RuleSet.g:347:4: ( (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] ) ( IF ie= expr )? )
            // RuleSet.g:347:5: (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] ) ( IF ie= expr )?
            {
            // RuleSet.g:347:5: (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] )
            int alt20=4;
            alt20 = dfa20.predict(input);
            switch (alt20) {
                case 1 :
                    // RuleSet.g:347:6: pe= persistent_expr
                    {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:348:6: rs= raise_statement
                    {
                    ...
                    break;
                case 3 :
                    // RuleSet.g:349:4: l= log_statement
                    {
                    ...
                    break;
                case 4 :
                    // RuleSet.g:350:4: las= must_be[\"last\"]
                    {
    ...
    // RuleSet.g:377:1: raise_statement returns [HashMap result] : must_be[\"raise\"] must_be[\"explicit\"] must_be[\"event\"] evt= VAR (f= for_clause )? (m= modifier_clause )? ;
    public final RuleSetParser.raise_statement_return raise_statement() throws RecognitionException {
        ...
        try {
            // RuleSet.g:378:2: ( must_be[\"raise\"] must_be[\"explicit\"] must_be[\"event\"] evt= VAR (f= for_clause )? (m= modifier_clause )? )
            // RuleSet.g:379:2: must_be[\"raise\"] must_be[\"explicit\"] must_be[\"event\"] evt= VAR (f= for_clause )? (m= modifier_clause )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:379:80: (m= modifier_clause )?
            int alt23=2;
    ...
    // RuleSet.g:394:1: log_statement returns [HashMap result] : must_be[\"log\"] e= expr ;
    public final RuleSetParser.log_statement_return log_statement() throws RecognitionException {
        ...
        try {
            // RuleSet.g:395:2: ( must_be[\"log\"] e= expr )
            // RuleSet.g:396:2: must_be[\"log\"] e= expr
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:404:1: callbacks returns [HashMap result] : CALLBACKS LEFT_CURL (s= success )? (f= failure )? RIGHT_CURL ;
    public final RuleSetParser.callbacks_return callbacks() throws RecognitionException {
        ...
        try {
            // RuleSet.g:405:2: ( CALLBACKS LEFT_CURL (s= success )? (f= failure )? RIGHT_CURL )
            // RuleSet.g:406:2: CALLBACKS LEFT_CURL (s= success )? (f= failure )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "success"
    // RuleSet.g:420:1: success returns [ArrayList result] : SUCCESS LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL ;
    public final RuleSetParser.success_return success() throws RecognitionException {
        ...
        try {
            // RuleSet.g:424:2: ( SUCCESS LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL )
            // RuleSet.g:424:4: SUCCESS LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:424:58: ( SEMI c1= click )*
            loop26:
            do {
                int alt26=2;
                ...
                switch (alt26) {
            	case 1 :
            	    // RuleSet.g:424:59: SEMI c1= click
            	    {
    ...
    // $ANTLR start "failure"
    // RuleSet.g:430:1: failure returns [ArrayList result] : FAILURE LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL ;
    public final RuleSetParser.failure_return failure() throws RecognitionException {
        ...
        try {
            // RuleSet.g:434:2: ( FAILURE LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL )
            // RuleSet.g:435:2: FAILURE LEFT_CURL c= click ( SEMI c1= click )* ( SEMI )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:435:56: ( SEMI c1= click )*
            loop28:
            do {
                int alt28=2;
                ...
                switch (alt28) {
            	case 1 :
            	    // RuleSet.g:435:57: SEMI c1= click
            	    {
    ...
    // $ANTLR start "click"
    // RuleSet.g:440:1: click returns [HashMap result] : corc= must_be_one[sar(\"click\",\"change\")] attr= VAR EQUAL val= STRING (cl= click_link )? ;
    public final RuleSetParser.click_return click() throws RecognitionException {
        ...
        try {
            // RuleSet.g:440:31: (corc= must_be_one[sar(\"click\",\"change\")] attr= VAR EQUAL val= STRING (cl= click_link )? )
            // RuleSet.g:441:2: corc= must_be_one[sar(\"click\",\"change\")] attr= VAR EQUAL val= STRING (cl= click_link )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:441:70: (cl= click_link )?
            int alt30=2;
    ...
    // RuleSet.g:451:1: click_link returns [HashMap result] : must_be[\"triggers\"] p= persistent_expr ;
    public final RuleSetParser.click_link_return click_link() throws RecognitionException {
        ...
        try {
            // RuleSet.g:452:2: ( must_be[\"triggers\"] p= persistent_expr )
            // RuleSet.g:453:2: must_be[\"triggers\"] p= persistent_expr
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:459:1: persistent_expr returns [HashMap result] : (pc= persistent_clear_set | pi= persistent_iterate | tf= trail_forget | tm= trail_mark );
    public final RuleSetParser.persistent_expr_return persistent_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:460:2: (pc= persistent_clear_set | pi= persistent_iterate | tf= trail_forget | tm= trail_mark )
            int alt31=4;
            switch ( input.LA(1) ) {
            case VAR:
                {
            ...
            switch (alt31) {
                case 1 :
                    // RuleSet.g:461:2: pc= persistent_clear_set
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // RuleSet.g:464:4: pi= persistent_iterate
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // RuleSet.g:467:7: tf= trail_forget
                    {
                    root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:476:1: persistent_clear_set returns [HashMap result] : cs= must_be_one[sar(\"clear\",\"set\")] dm= VAR_DOMAIN COLON name= VAR ;
    public final RuleSetParser.persistent_clear_set_return persistent_clear_set() throws RecognitionException {
        ...
        try {
            // RuleSet.g:477:2: (cs= must_be_one[sar(\"clear\",\"set\")] dm= VAR_DOMAIN COLON name= VAR )
            // RuleSet.g:478:2: cs= must_be_one[sar(\"clear\",\"set\")] dm= VAR_DOMAIN COLON name= VAR
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:489:1: persistent_iterate returns [HashMap result] : dm= VAR_DOMAIN COLON name= VAR op= COUNTER_OP v= expr from= counter_start ;
    public final RuleSetParser.persistent_iterate_return persistent_iterate() throws RecognitionException {
        ...
        try {
            // RuleSet.g:490:2: (dm= VAR_DOMAIN COLON name= VAR op= COUNTER_OP v= expr from= counter_start )
            // RuleSet.g:491:2: dm= VAR_DOMAIN COLON name= VAR op= COUNTER_OP v= expr from= counter_start
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:503:1: trail_forget returns [HashMap result] : FORGET what= STRING must_be[\"in\"] dm= VAR_DOMAIN COLON name= VAR ;
    public final RuleSetParser.trail_forget_return trail_forget() throws RecognitionException {
        ...
        try {
            // RuleSet.g:504:2: ( FORGET what= STRING must_be[\"in\"] dm= VAR_DOMAIN COLON name= VAR )
            // RuleSet.g:505:2: FORGET what= STRING must_be[\"in\"] dm= VAR_DOMAIN COLON name= VAR
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:517:1: trail_mark returns [HashMap result] : MARK dm= VAR_DOMAIN COLON name= VAR (t= trail_with )? ;
    public final RuleSetParser.trail_mark_return trail_mark() throws RecognitionException {
        ...
        try {
            // RuleSet.g:518:2: ( MARK dm= VAR_DOMAIN COLON name= VAR (t= trail_with )? )
            // RuleSet.g:519:2: MARK dm= VAR_DOMAIN COLON name= VAR (t= trail_with )?
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:531:1: trail_with returns [Object result] : WITH e= expr ;
    public final RuleSetParser.trail_with_return trail_with() throws RecognitionException {
        ...
        try {
            // RuleSet.g:532:2: ( WITH e= expr )
            // RuleSet.g:533:2: WITH e= expr
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:538:1: counter_start returns [Object result] : must_be[\"from\"] e= expr ;
    public final RuleSetParser.counter_start_return counter_start() throws RecognitionException {
        ...
        try {
            // RuleSet.g:539:2: ( must_be[\"from\"] e= expr )
            // RuleSet.g:540:2: must_be[\"from\"] e= expr
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:546:1: for_clause returns [String result] : FOR v= VAR ;
    public final RuleSetParser.for_clause_return for_clause() throws RecognitionException {
        ...
        try {
            // RuleSet.g:547:2: ( FOR v= VAR )
            // RuleSet.g:548:2: FOR v= VAR
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "action"
    // RuleSet.g:562:1: action[HashMap result] : ( conditional_action[result] | unconditional_action[result] ) ( SEMI )? ;
    public final RuleSetParser.action_return action(HashMap result) throws RecognitionException {
        ...
        try {
            // RuleSet.g:571:2: ( ( conditional_action[result] | unconditional_action[result] ) ( SEMI )? )
            // RuleSet.g:572:2: ( conditional_action[result] | unconditional_action[result] ) ( SEMI )?
            {
            root_0 = (Object)adaptor.nil();

            // RuleSet.g:572:2: ( conditional_action[result] | unconditional_action[result] )
            int alt33=2;
            ...
            switch (alt33) {
                case 1 :
                    // RuleSet.g:572:3: conditional_action[result]
                    {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:572:32: unconditional_action[result]
                    {
    ...
    // RuleSet.g:575:1: conditional_action[HashMap result] : IF e= expr must_be[\"then\"] unconditional_action[result] ;
    public final RuleSetParser.conditional_action_return conditional_action(HashMap result) throws RecognitionException {
        ...
        try {
            // RuleSet.g:576:2: ( IF e= expr must_be[\"then\"] unconditional_action[result] )
            // RuleSet.g:576:4: IF e= expr must_be[\"then\"] unconditional_action[result]
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:591:1: unconditional_action[HashMap result] : (p= primrule | action_block[result] );
    public final RuleSetParser.unconditional_action_return unconditional_action(HashMap result) throws RecognitionException {
        ...
        try {
            // RuleSet.g:595:2: (p= primrule | action_block[result] )
            int alt35=2;
            ...
            switch (alt35) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // RuleSet.g:596:6: action_block[result]
                    {
                    root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:598:1: action_block[HashMap result] : (at= ( EVERY | CHOOSE ) )? '{' (p= primrule ( ';' p= primrule )* ) ( ';' )? '}' ;
    public final RuleSetParser.action_block_return action_block(HashMap result) throws RecognitionException {
        ...
        try {
            // RuleSet.g:602:2: ( (at= ( EVERY | CHOOSE ) )? '{' (p= primrule ( ';' p= primrule )* ) ( ';' )? '}' )
            // RuleSet.g:602:4: (at= ( EVERY | CHOOSE ) )? '{' (p= primrule ( ';' p= primrule )* ) ( ';' )? '}'
            {
            root_0 = (Object)adaptor.nil();

            // RuleSet.g:602:6: (at= ( EVERY | CHOOSE ) )?
            int alt36=2;
            ...
            // RuleSet.g:603:7: (p= primrule ( ';' p= primrule )* )
            // RuleSet.g:603:8: p= primrule ( ';' p= primrule )*
            {
    ...
    // RuleSet.g:609:1: primrule returns [HashMap result] : (label= VAR ARROW_RIGHT )? ( (src= namespace )? name= ( VAR | REPLACE | MATCH | OTHER_OPERATORS ) LEFT_PAREN (ex= expr ( COMMA ex1= expr )* )? ( COMMA )? RIGHT_PAREN (set= setting )? (m= modifier_clause )? | (label= VAR ARROW_RIGHT )? e= emit_block ) ;
    public final RuleSetParser.primrule_return primrule() throws RecognitionException {
        ...
        try {
            // RuleSet.g:613:2: ( (label= VAR ARROW_RIGHT )? ( (src= namespace )? name= ( VAR | REPLACE | MATCH | OTHER_OPERATORS ) LEFT_PAREN (ex= expr ( COMMA ex1= expr )* )? ( COMMA )? RIGHT_PAREN (set= setting )? (m= modifier_clause )? | (label= VAR ARROW_RIGHT )? e= emit_block ) )
            // RuleSet.g:613:5: (label= VAR ARROW_RIGHT )? ( (src= namespace )? name= ( VAR | REPLACE | MATCH | OTHER_OPERATORS ) LEFT_PAREN (ex= expr ( COMMA ex1= expr )* )? ( COMMA )? RIGHT_PAREN (set= setting )? (m= modifier_clause )? | (label= VAR ARROW_RIGHT )? e= emit_block )
            {
            root_0 = (Object)adaptor.nil();

            // RuleSet.g:613:5: (label= VAR ARROW_RIGHT )?
            int alt39=2;
            ...
            switch (alt39) {
                case 1 :
                    // RuleSet.g:613:6: label= VAR ARROW_RIGHT
                    {
            ...
            // RuleSet.g:613:30: ( (src= namespace )? name= ( VAR | REPLACE | MATCH | OTHER_OPERATORS ) LEFT_PAREN (ex= expr ( COMMA ex1= expr )* )? ( COMMA )? RIGHT_PAREN (set= setting )? (m= modifier_clause )? | (label= VAR ARROW_RIGHT )? e= emit_block )
            int alt47=2;
            switch ( input.LA(1) ) {
            case VAR:
                {
            ...
            switch (alt47) {
                case 1 :
                    // RuleSet.g:614:4: (src= namespace )? name= ( VAR | REPLACE | MATCH | OTHER_OPERATORS ) LEFT_PAREN (ex= expr ( COMMA ex1= expr )* )? ( COMMA )? RIGHT_PAREN (set= setting )? (m= modifier_clause )?
                    {
                    // RuleSet.g:614:7: (src= namespace )?
                    int alt40=2;
                    ...
                    // RuleSet.g:614:72: (ex= expr ( COMMA ex1= expr )* )?
                    int alt42=2;
                    ...
                    switch (alt42) {
                        case 1 :
                            // RuleSet.g:614:73: ex= expr ( COMMA ex1= expr )*
                            {
                            ...
                            // RuleSet.g:614:110: ( COMMA ex1= expr )*
                            loop41:
                            do {
                                int alt41=2;
                                ...
                                switch (alt41) {
                            	case 1 :
                            	    // RuleSet.g:614:111: COMMA ex1= expr
                            	    {
                    ...
                    // RuleSet.g:614:195: (m= modifier_clause )?
                    int alt45=2;
                    ...
                    break;
                case 2 :
                    // RuleSet.g:638:4: (label= VAR ARROW_RIGHT )? e= emit_block
                    {
                    // RuleSet.g:638:4: (label= VAR ARROW_RIGHT )?
                    int alt46=2;
                    ...
                    switch (alt46) {
                        case 1 :
                            // RuleSet.g:638:5: label= VAR ARROW_RIGHT
                            {
    ...
    // RuleSet.g:652:1: modifier_clause returns [ArrayList result] : WITH m= modifier ( AND_AND m1= modifier )* ;
    public final RuleSetParser.modifier_clause_return modifier_clause() throws RecognitionException {
        ...
        try {
            // RuleSet.g:656:2: ( WITH m= modifier ( AND_AND m1= modifier )* )
            // RuleSet.g:657:2: WITH m= modifier ( AND_AND m1= modifier )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:657:46: ( AND_AND m1= modifier )*
            loop48:
            do {
                int alt48=2;
                ...
                switch (alt48) {
            	case 1 :
            	    // RuleSet.g:657:47: AND_AND m1= modifier
            	    {
    ...
    // RuleSet.g:663:1: modifier returns [HashMap result] : name= VAR EQUAL (e= expr | j= JS ) ;
    public final RuleSetParser.modifier_return modifier() throws RecognitionException {
        ...
        try {
            // RuleSet.g:664:2: (name= VAR EQUAL (e= expr | j= JS ) )
            // RuleSet.g:664:4: name= VAR EQUAL (e= expr | j= JS )
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "using"
    // RuleSet.g:690:1: using returns [HashMap result] : USING (p= STRING | r= regex ) (s= setting )? ;
    public final RuleSetParser.using_return using() throws RecognitionException {
        ...
        try {
            // RuleSet.g:691:2: ( USING (p= STRING | r= regex ) (s= setting )? )
            // RuleSet.g:691:4: USING (p= STRING | r= regex ) (s= setting )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:691:10: (p= STRING | r= regex )
            int alt50=2;
    ...
    // $ANTLR start "setting"
    // RuleSet.g:711:1: setting returns [ArrayList result] : SETTING LEFT_PAREN (v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH ) ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )* )? RIGHT_PAREN ;
    public final RuleSetParser.setting_return setting() throws RecognitionException {
        ...
        try {
            // RuleSet.g:715:2: ( SETTING LEFT_PAREN (v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH ) ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )* )? RIGHT_PAREN )
            // RuleSet.g:715:4: SETTING LEFT_PAREN (v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH ) ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )* )? RIGHT_PAREN
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:715:23: (v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH ) ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )* )?
            int alt53=2;
            ...
            switch (alt53) {
                case 1 :
                    // RuleSet.g:715:24: v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH ) ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )*
                    {
                    v=(Token)input.LT(1);
                    ...
                    // RuleSet.g:715:90: ( COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH ) )*
                    loop52:
                    do {
                        int alt52=2;
                        ...
                        switch (alt52) {
                    	case 1 :
                    	    // RuleSet.g:715:91: COMMA v2= ( VAR | LIKE | OTHER_OPERATORS | REPLACE | MATCH )
                    	    {
    ...
    // RuleSet.g:721:1: pre_block returns [ArrayList result] : PRE LEFT_CURL ( decl[tmp] ( SEMI decl[tmp] )* )? ( SEMI )? RIGHT_CURL ;
    public final RuleSetParser.pre_block_return pre_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:724:3: ( PRE LEFT_CURL ( decl[tmp] ( SEMI decl[tmp] )* )? ( SEMI )? RIGHT_CURL )
            // RuleSet.g:725:3: PRE LEFT_CURL ( decl[tmp] ( SEMI decl[tmp] )* )? ( SEMI )? RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:725:17: ( decl[tmp] ( SEMI decl[tmp] )* )?
            int alt55=2;
            ...
            switch (alt55) {
                case 1 :
                    // RuleSet.g:725:19: decl[tmp] ( SEMI decl[tmp] )*
                    {
                    ...
                    // RuleSet.g:725:29: ( SEMI decl[tmp] )*
                    loop54:
                    do {
                        int alt54=2;
                        ...
                        switch (alt54) {
                    	case 1 :
                    	    // RuleSet.g:725:30: SEMI decl[tmp]
                    	    {
    ...
    // $ANTLR start "foreach"
    // RuleSet.g:730:1: foreach returns [HashMap result] : FOREACH e= expr s= setting ;
    public final RuleSetParser.foreach_return foreach() throws RecognitionException {
        ...
        try {
            // RuleSet.g:731:2: ( FOREACH e= expr s= setting )
            // RuleSet.g:732:2: FOREACH e= expr s= setting
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "when"
    // RuleSet.g:739:1: when returns [HashMap result] : WHEN es= event_seq ;
    public final RuleSetParser.when_return when() throws RecognitionException {
        ...
        try {
            // RuleSet.g:742:2: ( WHEN es= event_seq )
            // RuleSet.g:743:2: WHEN es= event_seq
            {
            root_0 = (Object)adaptor.nil();
    ...
    // RuleSet.g:752:1: event_seq returns [HashMap result] : eor= event_or (tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or )* ;
    public final RuleSetParser.event_seq_return event_seq() throws RecognitionException {
        ...
        try {
            // RuleSet.g:757:2: (eor= event_or (tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or )* )
            // RuleSet.g:758:3: eor= event_or (tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:758:16: (tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or )*
            loop57:
            do {
                int alt57=2;
                ...
                switch (alt57) {
            	case 1 :
            	    // RuleSet.g:758:17: tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or
            	    {
    ...
    // RuleSet.g:803:1: event_or returns [HashMap result] : ea= event_and ( OR_OR ea1= event_and )* ;
    public final RuleSetParser.event_or_return event_or() throws RecognitionException {
        ...
        try {
            // RuleSet.g:807:2: (ea= event_and ( OR_OR ea1= event_and )* )
            // RuleSet.g:808:3: ea= event_and ( OR_OR ea1= event_and )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:808:37: ( OR_OR ea1= event_and )*
            loop58:
            do {
                int alt58=2;
                ...
                switch (alt58) {
            	case 1 :
            	    // RuleSet.g:808:38: OR_OR ea1= event_and
            	    {
    ...
    // RuleSet.g:848:1: event_and returns [HashMap result] : e= event_btwn ( AND_AND e1= event_btwn )* ;
    public final RuleSetParser.event_and_return event_and() throws RecognitionException {
        ...
        try {
            // RuleSet.g:852:2: (e= event_btwn ( AND_AND e1= event_btwn )* )
            // RuleSet.g:853:3: e= event_btwn ( AND_AND e1= event_btwn )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:853:36: ( AND_AND e1= event_btwn )*
            loop59:
            do {
                int alt59=2;
                ...
                switch (alt59) {
            	case 1 :
            	    // RuleSet.g:853:37: AND_AND e1= event_btwn
            	    {
    ...
    // RuleSet.g:894:1: event_btwn returns [HashMap result] : ep= event_prim ( (not= NOT )? BETWEEN LEFT_PAREN es1= event_seq COMMA es2= event_seq RIGHT_PAREN )? ;
    public final RuleSetParser.event_btwn_return event_btwn() throws RecognitionException {
        ...
        try {
            // RuleSet.g:895:2: (ep= event_prim ( (not= NOT )? BETWEEN LEFT_PAREN es1= event_seq COMMA es2= event_seq RIGHT_PAREN )? )
            // RuleSet.g:896:3: ep= event_prim ( (not= NOT )? BETWEEN LEFT_PAREN es1= event_seq COMMA es2= event_seq RIGHT_PAREN )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:896:17: ( (not= NOT )? BETWEEN LEFT_PAREN es1= event_seq COMMA es2= event_seq RIGHT_PAREN )?
            int alt61=2;
            ...
            switch (alt61) {
                case 1 :
                    // RuleSet.g:896:18: (not= NOT )? BETWEEN LEFT_PAREN es1= event_seq COMMA es2= event_seq RIGHT_PAREN
                    {
                    // RuleSet.g:896:18: (not= NOT )?
                    int alt60=2;
    ...
    // RuleSet.g:920:1: event_prim returns [HashMap result] : ( ( custom_event )=>ce= custom_event | (web= WEB )? PAGEVIEW (spat= STRING | rpat= regex ) (set= setting )? | (web= WEB )? opt= must_be_one[sar(\"submit\",\"click\",\"dblclick\",\"change\",\"update\")] elem= STRING (on= on_expr )? (set= setting )? | '(' evt= event_seq ')' );
    public final RuleSetParser.event_prim_return event_prim() throws RecognitionException {
        ...
        try {
            // RuleSet.g:924:2: ( ( custom_event )=>ce= custom_event | (web= WEB )? PAGEVIEW (spat= STRING | rpat= regex ) (set= setting )? | (web= WEB )? opt= must_be_one[sar(\"submit\",\"click\",\"dblclick\",\"change\",\"update\")] elem= STRING (on= on_expr )? (set= setting )? | '(' evt= event_seq ')' )
            int alt68=4;
            alt68 = dfa68.predict(input);
            switch (alt68) {
                case 1 :
                    // RuleSet.g:925:2: ( custom_event )=>ce= custom_event
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // RuleSet.g:928:4: (web= WEB )? PAGEVIEW (spat= STRING | rpat= regex ) (set= setting )?
                    {
                    root_0 = (Object)adaptor.nil();

                    // RuleSet.g:928:7: (web= WEB )?
                    int alt62=2;
                    ...
                    // RuleSet.g:928:22: (spat= STRING | rpat= regex )
                    int alt63=2;
                    ...
                    break;
                case 3 :
                    // RuleSet.g:940:4: (web= WEB )? opt= must_be_one[sar(\"submit\",\"click\",\"dblclick\",\"change\",\"update\")] elem= STRING (on= on_expr )? (set= setting )?
                    {
                    root_0 = (Object)adaptor.nil();

                    // RuleSet.g:940:7: (web= WEB )?
                    int alt65=2;
    ...
    // RuleSet.g:958:1: custom_event returns [HashMap result] : dom= ( VAR | WEB ) oper= VAR (filter= event_filter )* (set= setting )? ;
    public final RuleSetParser.custom_event_return custom_event() throws RecognitionException {
        ...
        try {
            // RuleSet.g:962:5: (dom= ( VAR | WEB ) oper= VAR (filter= event_filter )* (set= setting )? )
            // RuleSet.g:963:9: dom= ( VAR | WEB ) oper= VAR (filter= event_filter )* (set= setting )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:963:32: (filter= event_filter )*
            loop69:
            do {
                int alt69=2;
                ...
                switch (alt69) {
            	case 1 :
            	    // RuleSet.g:963:33: filter= event_filter
            	    {
    ...
    // RuleSet.g:975:1: event_filter returns [HashMap result] : typ= VAR (sfilt= STRING | rfilt= regex ) ;
    public final RuleSetParser.event_filter_return event_filter() throws RecognitionException {
        ...
        try {
            // RuleSet.g:976:2: (typ= VAR (sfilt= STRING | rfilt= regex ) )
            // RuleSet.g:976:4: typ= VAR (sfilt= STRING | rfilt= regex )
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:976:12: (sfilt= STRING | rfilt= regex )
            int alt71=2;
    ...
    // $ANTLR start "on_expr"
    // RuleSet.g:987:1: on_expr returns [Object result] : ON (s= STRING | r= regex ) ;
    public final RuleSetParser.on_expr_return on_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:987:32: ( ON (s= STRING | r= regex ) )
            // RuleSet.g:987:34: ON (s= STRING | r= regex )
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:988:2: (s= STRING | r= regex )
            int alt72=2;
    ...
    // RuleSet.g:994:2: global_block : GLOBAL LEFT_CURL (emt= emit_block | dst= must_be_one[sar(\"dataset\",\"datasource\")] name= VAR ( COLON dtype= DTYPE )? LEFT_SMALL_ARROW src= STRING (cas= cachable )? | cemt= css_emit | decl[global_block_array] | SEMI )* RIGHT_CURL ;
    public final RuleSetParser.global_block_return global_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1001:2: ( GLOBAL LEFT_CURL (emt= emit_block | dst= must_be_one[sar(\"dataset\",\"datasource\")] name= VAR ( COLON dtype= DTYPE )? LEFT_SMALL_ARROW src= STRING (cas= cachable )? | cemt= css_emit | decl[global_block_array] | SEMI )* RIGHT_CURL )
            // RuleSet.g:1001:4: GLOBAL LEFT_CURL (emt= emit_block | dst= must_be_one[sar(\"dataset\",\"datasource\")] name= VAR ( COLON dtype= DTYPE )? LEFT_SMALL_ARROW src= STRING (cas= cachable )? | cemt= css_emit | decl[global_block_array] | SEMI )* RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:1002:2: (emt= emit_block | dst= must_be_one[sar(\"dataset\",\"datasource\")] name= VAR ( COLON dtype= DTYPE )? LEFT_SMALL_ARROW src= STRING (cas= cachable )? | cemt= css_emit | decl[global_block_array] | SEMI )*
            loop75:
            do {
                int alt75=6;
                switch ( input.LA(1) ) {
                ...
                switch (alt75) {
            	case 1 :
            	    // RuleSet.g:1002:4: emt= emit_block
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // RuleSet.g:1007:4: dst= must_be_one[sar(\"dataset\",\"datasource\")] name= VAR ( COLON dtype= DTYPE )? LEFT_SMALL_ARROW src= STRING (cas= cachable )?
            	    {
            	    ...
            	    // RuleSet.g:1007:58: ( COLON dtype= DTYPE )?
            	    int alt73=2;
            	    ...
            	    switch (alt73) {
            	        case 1 :
            	            // RuleSet.g:1007:59: COLON dtype= DTYPE
            	            {
            	    ...
            	    // RuleSet.g:1007:107: (cas= cachable )?
            	    int alt74=2;
            	    ...
            	    switch (alt74) {
            	        case 1 :
            	            // RuleSet.g:1007:108: cas= cachable
            	            {
            	    ...
            	    break;
            	case 3 :
            	    // RuleSet.g:1042:4: cemt= css_emit
            	    {
            	    ...
            	    break;
            	case 4 :
            	    // RuleSet.g:1048:4: decl[global_block_array]
            	    {
    ...
    // $ANTLR start "decl"
    // RuleSet.g:1056:1: decl[ArrayList block_array] : var= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) EQUAL (hval= HTML | jval= JS | e= expr ) ;
    public final RuleSetParser.decl_return decl(ArrayList  block_array) throws RecognitionException {
        ...
        try {
            // RuleSet.g:1059:2: (var= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) EQUAL (hval= HTML | jval= JS | e= expr ) )
            // RuleSet.g:1060:2: var= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) EQUAL (hval= HTML | jval= JS | e= expr )
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:1060:64: (hval= HTML | jval= JS | e= expr )
            int alt76=3;
            switch ( input.LA(1) ) {
            case HTML:
                {
    ...
    // $ANTLR start "expr"
    // RuleSet.g:1084:1: expr returns [Object result] : (fd= function_def | c= conditional_expression ) ;
    public final RuleSetParser.expr_return expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1088:2: ( (fd= function_def | c= conditional_expression ) )
            // RuleSet.g:1088:4: (fd= function_def | c= conditional_expression )
            {
            root_0 = (Object)adaptor.nil();
            ...
            switch (alt77) {
                case 1 :
                    // RuleSet.g:1088:5: fd= function_def
                    {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1091:4: c= conditional_expression
                    {
    ...
    // RuleSet.g:1095:1: function_def returns [Object result] : FUNCTION LEFT_PAREN (args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )? ( COMMA args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )* RIGHT_PAREN LEFT_CURL (decs+= decl[block_array] )? ( SEMI decs+= decl[block_array] )* ( SEMI )? e1= expr RIGHT_CURL ;
    public final RuleSetParser.function_def_return function_def() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1099:2: ( FUNCTION LEFT_PAREN (args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )? ( COMMA args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )* RIGHT_PAREN LEFT_CURL (decs+= decl[block_array] )? ( SEMI decs+= decl[block_array] )* ( SEMI )? e1= expr RIGHT_CURL )
            // RuleSet.g:1099:4: FUNCTION LEFT_PAREN (args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )? ( COMMA args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )* RIGHT_PAREN LEFT_CURL (decs+= decl[block_array] )? ( SEMI decs+= decl[block_array] )* ( SEMI )? e1= expr RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:1099:28: (args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )?
            int alt78=2;
            ...
            // RuleSet.g:1099:83: ( COMMA args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) )*
            loop79:
            do {
                int alt79=2;
                ...
                switch (alt79) {
            	case 1 :
            	    // RuleSet.g:1099:84: COMMA args+= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
            	    {
            ...
            // RuleSet.g:1099:177: (decs+= decl[block_array] )?
            int alt80=2;
            switch ( input.LA(1) ) {
                case VAR_DOMAIN:
                    {
            ...
            // RuleSet.g:1099:198: ( SEMI decs+= decl[block_array] )*
            loop81:
            do {
                int alt81=2;
                ...
                switch (alt81) {
            	case 1 :
            	    // RuleSet.g:1099:199: SEMI decs+= decl[block_array]
            	    {
    ...
    // RuleSet.g:1119:1: conditional_expression returns [Object result] : d= disjunction ( ARROW_RIGHT e1= expr PIPE e2= expr )? ;
    public final RuleSetParser.conditional_expression_return conditional_expression() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1123:2: (d= disjunction ( ARROW_RIGHT e1= expr PIPE e2= expr )? )
            // RuleSet.g:1123:5: d= disjunction ( ARROW_RIGHT e1= expr PIPE e2= expr )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:1123:19: ( ARROW_RIGHT e1= expr PIPE e2= expr )?
            int alt83=2;
            ...
            switch (alt83) {
                case 1 :
                    // RuleSet.g:1123:20: ARROW_RIGHT e1= expr PIPE e2= expr
                    {
    ...
    // RuleSet.g:1144:1: disjunction returns [Object result] : me1= equality_expr (op= ( OR | AND ) me2= equality_expr )* ;
    public final RuleSetParser.disjunction_return disjunction() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1149:2: (me1= equality_expr (op= ( OR | AND ) me2= equality_expr )* )
            // RuleSet.g:1149:4: me1= equality_expr (op= ( OR | AND ) me2= equality_expr )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            // RuleSet.g:1149:22: (op= ( OR | AND ) me2= equality_expr )*
            loop84:
            do {
                int alt84=2;
                ...
                switch (alt84) {
            	case 1 :
            	    // RuleSet.g:1149:23: op= ( OR | AND ) me2= equality_expr
            	    {
            	    op=(Token)input.LT(1);
    ...
    // RuleSet.g:1171:1: equality_expr returns [Object result] : me1= add_expr (op= ( PREDOP | LIKE ) me2= add_expr )* ;
    public final RuleSetParser.equality_expr_return equality_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1176:2: (me1= add_expr (op= ( PREDOP | LIKE ) me2= add_expr )* )
            // RuleSet.g:1176:4: me1= add_expr (op= ( PREDOP | LIKE ) me2= add_expr )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, me1.getTree());
            // RuleSet.g:1176:17: (op= ( PREDOP | LIKE ) me2= add_expr )*
            loop85:
            do {
                int alt85=2;
                ...
                switch (alt85) {
            	case 1 :
            	    // RuleSet.g:1176:18: op= ( PREDOP | LIKE ) me2= add_expr
            	    {
            	    op=(Token)input.LT(1);
    ...
    // RuleSet.g:1194:1: add_expr returns [Object result] : me1= unary_expr (op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr )* ;
    public final RuleSetParser.add_expr_return add_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1199:2: (me1= unary_expr (op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr )* )
            // RuleSet.g:1199:4: me1= unary_expr (op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr )*
            {
            root_0 = (Object)adaptor.nil();

            pushFollow(FOLLOW_unary_expr_in_add_expr2545);
            me1=unary_expr();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, me1.getTree());
            // RuleSet.g:1199:20: (op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr )*
            loop86:
            do {
                int alt86=2;
                ...
                switch (alt86) {
            	case 1 :
            	    // RuleSet.g:1199:21: op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr
            	    {
            	    op=(Token)input.LT(1);
            	    ...
            	    pushFollow(FOLLOW_unary_expr_in_add_expr2561);
            	    me2=unary_expr();
    ...
    public final RuleSetParser.unary_expr_return unary_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1222:2: ( NOT ue= unary_expr | SEEN rx= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) (t= timeframe )? | SEEN rx_1= STRING op= must_be_one[sar(\"before\",\"after\")] rx_2= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) pop= ( PREDOP | LIKE ) e= expr t= timeframe | vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) t= timeframe | roe= regex | oe= operator_expr )
            int alt88=7;
            alt88 = dfa88.predict(input);
            switch (alt88) {
                case 1 :
                    // RuleSet.g:1222:4: NOT ue= unary_expr
                    {
                    root_0 = (Object)adaptor.nil();

                    NOT123=(Token)match(input,NOT,FOLLOW_NOT_in_unary_expr2605); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    NOT123_tree = (Object)adaptor.create(NOT123);
                    adaptor.addChild(root_0, NOT123_tree);
                    }
                    pushFollow(FOLLOW_unary_expr_in_unary_expr2609);
                    ue=unary_expr();
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1231:4: SEEN rx= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) (t= timeframe )?
                    {
                    root_0 = (Object)adaptor.nil();

                    SEEN124=(Token)match(input,SEEN,FOLLOW_SEEN_in_unary_expr2618); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    SEEN124_tree = (Object)adaptor.create(SEEN124);
                    adaptor.addChild(root_0, SEEN124_tree);
                    }
                    rx=(Token)match(input,STRING,FOLLOW_STRING_in_unary_expr2622); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    rx_tree = (Object)adaptor.create(rx);
                    adaptor.addChild(root_0, rx_tree);
                    }
                    pushFollow(FOLLOW_must_be_in_unary_expr2624);
                    must_be125=must_be("in");

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, must_be125.getTree());
                    vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_unary_expr2629); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    vd_tree = (Object)adaptor.create(vd);
                    adaptor.addChild(root_0, vd_tree);
                    }
                    char_literal126=(Token)match(input,COLON,FOLLOW_COLON_in_unary_expr2631); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    // RuleSet.g:1231:106: (t= timeframe )?
                    int alt87=2;
                    ...
                    switch (alt87) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_timeframe_in_unary_expr2651);
                            t=timeframe();
                    ...
                    break;
                case 3 :
                    // RuleSet.g:1242:4: SEEN rx_1= STRING op= must_be_one[sar(\"before\",\"after\")] rx_2= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
                    {
                    root_0 = (Object)adaptor.nil();

                    SEEN127=(Token)match(input,SEEN,FOLLOW_SEEN_in_unary_expr2659); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    SEEN127_tree = (Object)adaptor.create(SEEN127);
                    adaptor.addChild(root_0, SEEN127_tree);
                    }
                    rx_1=(Token)match(input,STRING,FOLLOW_STRING_in_unary_expr2663); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    rx_1_tree = (Object)adaptor.create(rx_1);
                    adaptor.addChild(root_0, rx_1_tree);
                    }
                    pushFollow(FOLLOW_must_be_one_in_unary_expr2667);
                    op=must_be_one(sar("before","after"));

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, op.getTree());
                    rx_2=(Token)match(input,STRING,FOLLOW_STRING_in_unary_expr2672); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    rx_2_tree = (Object)adaptor.create(rx_2);
                    adaptor.addChild(root_0, rx_2_tree);
                    }
                    pushFollow(FOLLOW_must_be_in_unary_expr2675);
                    must_be128=must_be("in");

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, must_be128.getTree());
                    vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_unary_expr2680); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    vd_tree = (Object)adaptor.create(vd);
                    adaptor.addChild(root_0, vd_tree);
                    }
                    char_literal129=(Token)match(input,COLON,FOLLOW_COLON_in_unary_expr2682); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 4 :
                    // RuleSet.g:1252:4: vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) pop= ( PREDOP | LIKE ) e= expr t= timeframe
                    {
                    root_0 = (Object)adaptor.nil();

                    vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_unary_expr2707); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    vd_tree = (Object)adaptor.create(vd);
                    adaptor.addChild(root_0, vd_tree);
                    }
                    COLON130=(Token)match(input,COLON,FOLLOW_COLON_in_unary_expr2709); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_expr_in_unary_expr2737);
                    e=expr();

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, e.getTree());
                    pushFollow(FOLLOW_timeframe_in_unary_expr2741);
                    t=timeframe();
                    ...
                    break;
                case 5 :
                    // RuleSet.g:1264:4: vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) t= timeframe
                    {
                    root_0 = (Object)adaptor.nil();

                    vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_unary_expr2751); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    vd_tree = (Object)adaptor.create(vd);
                    adaptor.addChild(root_0, vd_tree);
                    }
                    COLON131=(Token)match(input,COLON,FOLLOW_COLON_in_unary_expr2753); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_timeframe_in_unary_expr2773);
                    t=timeframe();
                    ...
                    break;
                case 6 :
                    // RuleSet.g:1279:4: roe= regex
                    {
                    root_0 = (Object)adaptor.nil();

                    pushFollow(FOLLOW_regex_in_unary_expr2782);
                    roe=regex();
                    ...
                    break;
                case 7 :
                    // RuleSet.g:1282:4: oe= operator_expr
                    {
                    root_0 = (Object)adaptor.nil();

                    pushFollow(FOLLOW_operator_expr_in_unary_expr2791);
                    oe=operator_expr();
    ...
    // RuleSet.g:1288:1: operator_expr returns [Object result] : f= factor (o= operator )* ;
    public final RuleSetParser.operator_expr_return operator_expr() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1293:2: (f= factor (o= operator )* )
            // RuleSet.g:1293:4: f= factor (o= operator )*
            {
            root_0 = (Object)adaptor.nil();

            pushFollow(FOLLOW_factor_in_operator_expr2820);
            f=factor();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, f.getTree());
            // RuleSet.g:1293:14: (o= operator )*
            loop89:
            do {
                int alt89=2;
                ...
                switch (alt89) {
            	case 1 :
            	    // RuleSet.g:1293:15: o= operator
            	    {
            	    pushFollow(FOLLOW_operator_in_operator_expr2826);
            	    o=operator();
    ...
    // RuleSet.g:1331:1: operator returns [String oper,ArrayList exprs] : DOT (o= OTHER_OPERATORS LEFT_PAREN (e= expr ( ',' e1= expr )* )? RIGHT_PAREN | o1= MATCH LEFT_PAREN e= expr RIGHT_PAREN | o2= REPLACE LEFT_PAREN rx= expr ',' e1= expr RIGHT_PAREN ) ;
    public final RuleSetParser.operator_return operator() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1336:2: ( DOT (o= OTHER_OPERATORS LEFT_PAREN (e= expr ( ',' e1= expr )* )? RIGHT_PAREN | o1= MATCH LEFT_PAREN e= expr RIGHT_PAREN | o2= REPLACE LEFT_PAREN rx= expr ',' e1= expr RIGHT_PAREN ) )
            // RuleSet.g:1336:4: DOT (o= OTHER_OPERATORS LEFT_PAREN (e= expr ( ',' e1= expr )* )? RIGHT_PAREN | o1= MATCH LEFT_PAREN e= expr RIGHT_PAREN | o2= REPLACE LEFT_PAREN rx= expr ',' e1= expr RIGHT_PAREN )
            {
            root_0 = (Object)adaptor.nil();

            DOT132=(Token)match(input,DOT,FOLLOW_DOT_in_operator2853); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            DOT132_tree = (Object)adaptor.create(DOT132);
            adaptor.addChild(root_0, DOT132_tree);
            }
            // RuleSet.g:1336:8: (o= OTHER_OPERATORS LEFT_PAREN (e= expr ( ',' e1= expr )* )? RIGHT_PAREN | o1= MATCH LEFT_PAREN e= expr RIGHT_PAREN | o2= REPLACE LEFT_PAREN rx= expr ',' e1= expr RIGHT_PAREN )
            int alt92=3;
            switch ( input.LA(1) ) {
            case OTHER_OPERATORS:
                {
            ...
            switch (alt92) {
                case 1 :
                    // RuleSet.g:1336:10: o= OTHER_OPERATORS LEFT_PAREN (e= expr ( ',' e1= expr )* )? RIGHT_PAREN
                    {
                    o=(Token)match(input,OTHER_OPERATORS,FOLLOW_OTHER_OPERATORS_in_operator2859); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    o_tree = (Object)adaptor.create(o);
                    adaptor.addChild(root_0, o_tree);
                    }
                    LEFT_PAREN133=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_operator2861); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN133_tree = (Object)adaptor.create(LEFT_PAREN133);
                    adaptor.addChild(root_0, LEFT_PAREN133_tree);
                    }
                    // RuleSet.g:1336:39: (e= expr ( ',' e1= expr )* )?
                    int alt91=2;
                    int LA91_0 = input.LA(1);

                    if ( (LA91_0==LEFT_CURL||(LA91_0>=VAR && LA91_0<=MATCH)||(LA91_0>=STRING && LA91_0<=VAR_DOMAIN)||LA91_0==LEFT_PAREN||LA91_0==NOT||LA91_0==FUNCTION||(LA91_0>=REX && LA91_0<=SEEN)||(LA91_0>=FLOAT && LA91_0<=LEFT_BRACKET)||(LA91_0>=CURRENT && LA91_0<=HISTORY)) ) {
                        alt91=1;
                    }
                    switch (alt91) {
                        case 1 :
                            // RuleSet.g:1336:40: e= expr ( ',' e1= expr )*
                            {
                            pushFollow(FOLLOW_expr_in_operator2866);
                            e=expr();
                            ...
                            do {
                                ...
                                switch (alt90) {
                            	case 1 :
                            	    // RuleSet.g:1336:73: ',' e1= expr
                            	    {
                            	    char_literal134=(Token)match(input,COMMA,FOLLOW_COMMA_in_operator2871); if (state.failed) return retval;
                            	    if ( state.backtracking==0 ) {
                            	    char_literal134_tree = (Object)adaptor.create(char_literal134);
                            	    adaptor.addChild(root_0, char_literal134_tree);
                            	    }
                            	    pushFollow(FOLLOW_expr_in_operator2875);
                            	    e1=expr();
                    ...
                    RIGHT_PAREN135=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_operator2884); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1342:9: o1= MATCH LEFT_PAREN e= expr RIGHT_PAREN
                    {
                    o1=(Token)match(input,MATCH,FOLLOW_MATCH_in_operator2908); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    o1_tree = (Object)adaptor.create(o1);
                    adaptor.addChild(root_0, o1_tree);
                    }
                    LEFT_PAREN136=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_operator2910); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN136_tree = (Object)adaptor.create(LEFT_PAREN136);
                    adaptor.addChild(root_0, LEFT_PAREN136_tree);
                    }
                    pushFollow(FOLLOW_expr_in_operator2914);
                    e=expr();
                    ...
                    RIGHT_PAREN137=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_operator2919); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 3 :
                    // RuleSet.g:1348:9: o2= REPLACE LEFT_PAREN rx= expr ',' e1= expr RIGHT_PAREN
                    {
                    o2=(Token)match(input,REPLACE,FOLLOW_REPLACE_in_operator2944); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    o2_tree = (Object)adaptor.create(o2);
                    adaptor.addChild(root_0, o2_tree);
                    }
                    LEFT_PAREN138=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_operator2946); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN138_tree = (Object)adaptor.create(LEFT_PAREN138);
                    adaptor.addChild(root_0, LEFT_PAREN138_tree);
                    }
                    pushFollow(FOLLOW_expr_in_operator2950);
                    rx=expr();
                    ...
                    char_literal139=(Token)match(input,COMMA,FOLLOW_COMMA_in_operator2954); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    char_literal139_tree = (Object)adaptor.create(char_literal139);
                    adaptor.addChild(root_0, char_literal139_tree);
                    }
                    pushFollow(FOLLOW_expr_in_operator2958);
                    e1=expr();

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, e1.getTree());
                    RIGHT_PAREN140=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_operator2961); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    public final RuleSetParser.factor_return factor() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1364:2: (iv= INT | sv= STRING | fv= FLOAT | bv= ( TRUE | FALSE ) | bv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_BRACKET e= expr RIGHT_BRACKET | d= VAR_DOMAIN COLON vv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | CURRENT d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | HISTORY e= expr d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | n= namespace p= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN | v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN | LEFT_BRACKET (e= expr ( COMMA e2= expr )* )? RIGHT_BRACKET | LEFT_CURL (h1= hash_line ( COMMA h2= hash_line )* )? RIGHT_CURL | LEFT_PAREN e= expr RIGHT_PAREN | v= ( VAR | OTHER_OPERATORS | REPLACE | MATCH ) | reg= regex )
            int alt101=15;
            alt101 = dfa101.predict(input);
            switch (alt101) {
                case 1 :
                    // RuleSet.g:1364:4: iv= INT
                    {
                    root_0 = (Object)adaptor.nil();

                    iv=(Token)match(input,INT,FOLLOW_INT_in_factor3001); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1370:9: sv= STRING
                    {
                    root_0 = (Object)adaptor.nil();

                    sv=(Token)match(input,STRING,FOLLOW_STRING_in_factor3016); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 3 :
                    // RuleSet.g:1376:9: fv= FLOAT
                    {
                    root_0 = (Object)adaptor.nil();

                    fv=(Token)match(input,FLOAT,FOLLOW_FLOAT_in_factor3036); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 4 :
                    // RuleSet.g:1382:9: bv= ( TRUE | FALSE )
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // RuleSet.g:1388:9: bv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_BRACKET e= expr RIGHT_BRACKET
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    LEFT_BRACKET141=(Token)match(input,LEFT_BRACKET,FOLLOW_LEFT_BRACKET_in_factor3090); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, e.getTree());
                    RIGHT_BRACKET142=(Token)match(input,RIGHT_BRACKET,FOLLOW_RIGHT_BRACKET_in_factor3096); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 6 :
                    // RuleSet.g:1402:9: d= VAR_DOMAIN COLON vv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
                    {
                    root_0 = (Object)adaptor.nil();

                    d=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_factor3111); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    d_tree = (Object)adaptor.create(d);
                    adaptor.addChild(root_0, d_tree);
                    }
                    COLON143=(Token)match(input,COLON,FOLLOW_COLON_in_factor3113); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 7 :
                    // RuleSet.g:1409:9: CURRENT d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
                    {
                    root_0 = (Object)adaptor.nil();

                    CURRENT144=(Token)match(input,CURRENT,FOLLOW_CURRENT_in_factor3141); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    CURRENT144_tree = (Object)adaptor.create(CURRENT144);
                    adaptor.addChild(root_0, CURRENT144_tree);
                    }
                    d=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_factor3145); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    d_tree = (Object)adaptor.create(d);
                    adaptor.addChild(root_0, d_tree);
                    }
                    COLON145=(Token)match(input,COLON,FOLLOW_COLON_in_factor3147); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 8 :
                    // RuleSet.g:1420:9: HISTORY e= expr d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
                    {
                    root_0 = (Object)adaptor.nil();

                    HISTORY146=(Token)match(input,HISTORY,FOLLOW_HISTORY_in_factor3176); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    HISTORY146_tree = (Object)adaptor.create(HISTORY146);
                    adaptor.addChild(root_0, HISTORY146_tree);
                    }
                    pushFollow(FOLLOW_expr_in_factor3180);
                    e=expr();

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, e.getTree());
                    d=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_factor3184); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    d_tree = (Object)adaptor.create(d);
                    adaptor.addChild(root_0, d_tree);
                    }
                    COLON147=(Token)match(input,COLON,FOLLOW_COLON_in_factor3186); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 9 :
                    // RuleSet.g:1430:9: n= namespace p= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN
                    {
                    root_0 = (Object)adaptor.nil();

                    pushFollow(FOLLOW_namespace_in_factor3216);
                    n=namespace();
                    ...
                    LEFT_PAREN148=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_factor3234); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN148_tree = (Object)adaptor.create(LEFT_PAREN148);
                    adaptor.addChild(root_0, LEFT_PAREN148_tree);
                    }
                    // RuleSet.g:1430:86: (e= expr ( COMMA e= expr )* )?
                    int alt94=2;
                    int LA94_0 = input.LA(1);

                    if ( (LA94_0==LEFT_CURL||(LA94_0>=VAR && LA94_0<=MATCH)||(LA94_0>=STRING && LA94_0<=VAR_DOMAIN)||LA94_0==LEFT_PAREN||LA94_0==NOT||LA94_0==FUNCTION||(LA94_0>=REX && LA94_0<=SEEN)||(LA94_0>=FLOAT && LA94_0<=LEFT_BRACKET)||(LA94_0>=CURRENT && LA94_0<=HISTORY)) ) {
                        alt94=1;
                    }
                    switch (alt94) {
                        case 1 :
                            // RuleSet.g:1430:87: e= expr ( COMMA e= expr )*
                            {
                            pushFollow(FOLLOW_expr_in_factor3239);
                            e=expr();
                            ...
                            // RuleSet.g:1430:121: ( COMMA e= expr )*
                            loop93:
                            do {
                                int alt93=2;
                                ...
                                switch (alt93) {
                            	case 1 :
                            	    // RuleSet.g:1430:123: COMMA e= expr
                            	    {
                            	    COMMA149=(Token)match(input,COMMA,FOLLOW_COMMA_in_factor3245); if (state.failed) return retval;
                            	    if ( state.backtracking==0 ) {
                            	    COMMA149_tree = (Object)adaptor.create(COMMA149);
                            	    adaptor.addChild(root_0, COMMA149_tree);
                            	    }
                            	    pushFollow(FOLLOW_expr_in_factor3249);
                            	    e=expr();
                    ...
                    RIGHT_PAREN150=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_factor3258); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 10 :
                    // RuleSet.g:1438:9: v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    LEFT_PAREN151=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_factor3287); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN151_tree = (Object)adaptor.create(LEFT_PAREN151);
                    adaptor.addChild(root_0, LEFT_PAREN151_tree);
                    }
                    // RuleSet.g:1438:74: (e= expr ( COMMA e= expr )* )?
                    int alt96=2;
                    int LA96_0 = input.LA(1);

                    if ( (LA96_0==LEFT_CURL||(LA96_0>=VAR && LA96_0<=MATCH)||(LA96_0>=STRING && LA96_0<=VAR_DOMAIN)||LA96_0==LEFT_PAREN||LA96_0==NOT||LA96_0==FUNCTION||(LA96_0>=REX && LA96_0<=SEEN)||(LA96_0>=FLOAT && LA96_0<=LEFT_BRACKET)||(LA96_0>=CURRENT && LA96_0<=HISTORY)) ) {
                        alt96=1;
                    }
                    switch (alt96) {
                        case 1 :
                            // RuleSet.g:1438:75: e= expr ( COMMA e= expr )*
                            {
                            pushFollow(FOLLOW_expr_in_factor3292);
                            e=expr();
                            ...
                            // RuleSet.g:1438:109: ( COMMA e= expr )*
                            loop95:
                            do {
                                int alt95=2;
                                ...
                                switch (alt95) {
                            	case 1 :
                            	    // RuleSet.g:1438:111: COMMA e= expr
                            	    {
                            	    COMMA152=(Token)match(input,COMMA,FOLLOW_COMMA_in_factor3297); if (state.failed) return retval;
                            	    if ( state.backtracking==0 ) {
                            	    COMMA152_tree = (Object)adaptor.create(COMMA152);
                            	    adaptor.addChild(root_0, COMMA152_tree);
                            	    }
                            	    pushFollow(FOLLOW_expr_in_factor3301);
                            	    e=expr();
                    ...
                    RIGHT_PAREN153=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_factor3310); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 11 :
                    // RuleSet.g:1449:9: LEFT_BRACKET (e= expr ( COMMA e2= expr )* )? RIGHT_BRACKET
                    {
                    root_0 = (Object)adaptor.nil();

                    LEFT_BRACKET154=(Token)match(input,LEFT_BRACKET,FOLLOW_LEFT_BRACKET_in_factor3322); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_BRACKET154_tree = (Object)adaptor.create(LEFT_BRACKET154);
                    adaptor.addChild(root_0, LEFT_BRACKET154_tree);
                    }
                    // RuleSet.g:1449:22: (e= expr ( COMMA e2= expr )* )?
                    int alt98=2;
                    int LA98_0 = input.LA(1);

                    if ( (LA98_0==LEFT_CURL||(LA98_0>=VAR && LA98_0<=MATCH)||(LA98_0>=STRING && LA98_0<=VAR_DOMAIN)||LA98_0==LEFT_PAREN||LA98_0==NOT||LA98_0==FUNCTION||(LA98_0>=REX && LA98_0<=SEEN)||(LA98_0>=FLOAT && LA98_0<=LEFT_BRACKET)||(LA98_0>=CURRENT && LA98_0<=HISTORY)) ) {
                        alt98=1;
                    }
                    switch (alt98) {
                        case 1 :
                            // RuleSet.g:1449:23: e= expr ( COMMA e2= expr )*
                            {
                            pushFollow(FOLLOW_expr_in_factor3327);
                            e=expr();
                            ...
                            // RuleSet.g:1449:57: ( COMMA e2= expr )*
                            loop97:
                            do {
                                int alt97=2;
                                ...
                                switch (alt97) {
                            	case 1 :
                            	    // RuleSet.g:1449:58: COMMA e2= expr
                            	    {
                            	    COMMA155=(Token)match(input,COMMA,FOLLOW_COMMA_in_factor3332); if (state.failed) return retval;
                            	    if ( state.backtracking==0 ) {
                            	    COMMA155_tree = (Object)adaptor.create(COMMA155);
                            	    adaptor.addChild(root_0, COMMA155_tree);
                            	    }
                            	    pushFollow(FOLLOW_expr_in_factor3336);
                            	    e2=expr();
                    ...
                    RIGHT_BRACKET156=(Token)match(input,RIGHT_BRACKET,FOLLOW_RIGHT_BRACKET_in_factor3344); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 12 :
                    // RuleSet.g:1456:9: LEFT_CURL (h1= hash_line ( COMMA h2= hash_line )* )? RIGHT_CURL
                    {
                    root_0 = (Object)adaptor.nil();

                    LEFT_CURL157=(Token)match(input,LEFT_CURL,FOLLOW_LEFT_CURL_in_factor3356); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_CURL157_tree = (Object)adaptor.create(LEFT_CURL157);
                    adaptor.addChild(root_0, LEFT_CURL157_tree);
                    }
                    // RuleSet.g:1456:19: (h1= hash_line ( COMMA h2= hash_line )* )?
                    int alt100=2;
                    ...
                    switch (alt100) {
                        case 1 :
                            // RuleSet.g:1456:20: h1= hash_line ( COMMA h2= hash_line )*
                            {
                            pushFollow(FOLLOW_hash_line_in_factor3361);
                            h1=hash_line();
                            ...
                            // RuleSet.g:1456:61: ( COMMA h2= hash_line )*
                            loop99:
                            do {
                                int alt99=2;
                                ...
                                switch (alt99) {
                            	case 1 :
                            	    // RuleSet.g:1456:62: COMMA h2= hash_line
                            	    {
                            	    COMMA158=(Token)match(input,COMMA,FOLLOW_COMMA_in_factor3366); if (state.failed) return retval;
                            	    if ( state.backtracking==0 ) {
                            	    COMMA158_tree = (Object)adaptor.create(COMMA158);
                            	    adaptor.addChild(root_0, COMMA158_tree);
                            	    }
                            	    pushFollow(FOLLOW_hash_line_in_factor3370);
                            	    h2=hash_line();
                    ...
                    RIGHT_CURL159=(Token)match(input,RIGHT_CURL,FOLLOW_RIGHT_CURL_in_factor3379); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 13 :
                    // RuleSet.g:1463:9: LEFT_PAREN e= expr RIGHT_PAREN
                    {
                    root_0 = (Object)adaptor.nil();

                    LEFT_PAREN160=(Token)match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_factor3391); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    LEFT_PAREN160_tree = (Object)adaptor.create(LEFT_PAREN160);
                    adaptor.addChild(root_0, LEFT_PAREN160_tree);
                    }
                    pushFollow(FOLLOW_expr_in_factor3395);
                    e=expr();

                    state._fsp--;
                    if (state.failed) return retval;
                    if ( state.backtracking==0 ) adaptor.addChild(root_0, e.getTree());
                    RIGHT_PAREN161=(Token)match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_factor3398); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 14 :
                    // RuleSet.g:1464:9: v= ( VAR | OTHER_OPERATORS | REPLACE | MATCH )
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 15 :
                    // RuleSet.g:1470:9: reg= regex
                    {
                    root_0 = (Object)adaptor.nil();

                    pushFollow(FOLLOW_regex_in_factor3441);
                    reg=regex();
    ...
    // RuleSet.g:1483:10: fragment namespace returns [String result] : v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) ':' ;
    public final RuleSetParser.namespace_return namespace() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1484:2: (v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) ':' )
            // RuleSet.g:1484:4: v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) ':'
            {
            root_0 = (Object)adaptor.nil();
            ...
            char_literal162=(Token)match(input,COLON,FOLLOW_COLON_in_namespace3488); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // RuleSet.g:1491:1: timeframe returns [Object result,String time] : WITHIN e= expr p= period ;
    public final RuleSetParser.timeframe_return timeframe() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1492:2: ( WITHIN e= expr p= period )
            // RuleSet.g:1492:5: WITHIN e= expr p= period
            {
            root_0 = (Object)adaptor.nil();

            WITHIN163=(Token)match(input,WITHIN,FOLLOW_WITHIN_in_timeframe3510); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            WITHIN163_tree = (Object)adaptor.create(WITHIN163);
            adaptor.addChild(root_0, WITHIN163_tree);
            }
            pushFollow(FOLLOW_expr_in_timeframe3514);
            e=expr();

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, e.getTree());
            pushFollow(FOLLOW_period_in_timeframe3518);
            p=period();
    ...
    // RuleSet.g:1500:1: hash_line returns [HashMap result] : s= STRING COLON e= expr ;
    public final RuleSetParser.hash_line_return hash_line() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1501:2: (s= STRING COLON e= expr )
            // RuleSet.g:1501:4: s= STRING COLON e= expr
            {
            root_0 = (Object)adaptor.nil();

            s=(Token)match(input,STRING,FOLLOW_STRING_in_hash_line3545); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            s_tree = (Object)adaptor.create(s);
            adaptor.addChild(root_0, s_tree);
            }
            COLON164=(Token)match(input,COLON,FOLLOW_COLON_in_hash_line3547); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            COLON164_tree = (Object)adaptor.create(COLON164);
            adaptor.addChild(root_0, COLON164_tree);
            }
            pushFollow(FOLLOW_expr_in_hash_line3551);
            e=expr();
    ...
    // RuleSet.g:1510:1: css_emit returns [String emit_value] : CSS (h= HTML | h= STRING ) ;
    public final RuleSetParser.css_emit_return css_emit() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1511:2: ( CSS (h= HTML | h= STRING ) )
            // RuleSet.g:1511:4: CSS (h= HTML | h= STRING )
            {
            root_0 = (Object)adaptor.nil();

            CSS165=(Token)match(input,CSS,FOLLOW_CSS_in_css_emit3569); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            CSS165_tree = (Object)adaptor.create(CSS165);
            adaptor.addChild(root_0, CSS165_tree);
            }
            // RuleSet.g:1511:8: (h= HTML | h= STRING )
            int alt102=2;
            ...
            switch (alt102) {
                case 1 :
                    // RuleSet.g:1511:10: h= HTML
                    {
                    h=(Token)match(input,HTML,FOLLOW_HTML_in_css_emit3575); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1512:3: h= STRING
                    {
                    h=(Token)match(input,STRING,FOLLOW_STRING_in_css_emit3583); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    h_tree = (Object)adaptor.create(h);
                    adaptor.addChild(root_0, h_tree);
                    }
    ...
    // $ANTLR start "period"
    // RuleSet.g:1516:1: period : must_be_one[sar( \"years\", \"months\", \"weeks\", \"days\", \"hours\", \"minutes\", \"seconds\", \"year\", \"month\", \"week\", \"day\", \"hour\", \"minute\", \"second\")] ;
    public final RuleSetParser.period_return period() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1517:2: ( must_be_one[sar( \"years\", \"months\", \"weeks\", \"days\", \"hours\", \"minutes\", \"seconds\", \"year\", \"month\", \"week\", \"day\", \"hour\", \"minute\", \"second\")] )
            // RuleSet.g:1518:3: must_be_one[sar( \"years\", \"months\", \"weeks\", \"days\", \"hours\", \"minutes\", \"seconds\", \"year\", \"month\", \"week\", \"day\", \"hour\", \"minute\", \"second\")]
            {
            root_0 = (Object)adaptor.nil();

            pushFollow(FOLLOW_must_be_one_in_period3603);
    ...
    // RuleSet.g:1538:1: cachable returns [Object what] : ca= CACHABLE ( FOR tm= INT per= period )? ;
    public final RuleSetParser.cachable_return cachable() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1542:2: (ca= CACHABLE ( FOR tm= INT per= period )? )
            // RuleSet.g:1543:3: ca= CACHABLE ( FOR tm= INT per= period )?
            {
            root_0 = (Object)adaptor.nil();

            ca=(Token)match(input,CACHABLE,FOLLOW_CACHABLE_in_cachable3637); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ca_tree = (Object)adaptor.create(ca);
            adaptor.addChild(root_0, ca_tree);
            }
            // RuleSet.g:1543:15: ( FOR tm= INT per= period )?
            int alt103=2;
            ...
            switch (alt103) {
                case 1 :
                    // RuleSet.g:1543:16: FOR tm= INT per= period
                    {
                    FOR167=(Token)match(input,FOR,FOLLOW_FOR_in_cachable3640); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    FOR167_tree = (Object)adaptor.create(FOR167);
                    adaptor.addChild(root_0, FOR167_tree);
                    }
                    tm=(Token)match(input,INT,FOLLOW_INT_in_cachable3644); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    tm_tree = (Object)adaptor.create(tm);
                    adaptor.addChild(root_0, tm_tree);
                    }
                    pushFollow(FOLLOW_period_in_cachable3648);
                    per=period();
    ...
    // RuleSet.g:1562:1: emit_block returns [String emit_value] : EMIT (h= HTML | h= STRING | h= JS ) ;
    public final RuleSetParser.emit_block_return emit_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1563:2: ( EMIT (h= HTML | h= STRING | h= JS ) )
            // RuleSet.g:1563:4: EMIT (h= HTML | h= STRING | h= JS )
            {
            root_0 = (Object)adaptor.nil();

            EMIT168=(Token)match(input,EMIT,FOLLOW_EMIT_in_emit_block3670); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            EMIT168_tree = (Object)adaptor.create(EMIT168);
            adaptor.addChild(root_0, EMIT168_tree);
            }
            // RuleSet.g:1563:9: (h= HTML | h= STRING | h= JS )
            int alt104=3;
            switch ( input.LA(1) ) {
            case HTML:
                {
            ...
            switch (alt104) {
                case 1 :
                    // RuleSet.g:1563:11: h= HTML
                    {
                    h=(Token)match(input,HTML,FOLLOW_HTML_in_emit_block3676); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    h_tree = (Object)adaptor.create(h);
                    adaptor.addChild(root_0, h_tree);
                    }
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1564:3: h= STRING
                    {
                    h=(Token)match(input,STRING,FOLLOW_STRING_in_emit_block3684); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    h_tree = (Object)adaptor.create(h);
                    adaptor.addChild(root_0, h_tree);
                    }
                    ...
                    break;
                case 3 :
                    // RuleSet.g:1565:3: h= JS
                    {
                    h=(Token)match(input,JS,FOLLOW_JS_in_emit_block3692); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    h_tree = (Object)adaptor.create(h);
                    adaptor.addChild(root_0, h_tree);
                    }
    ...
    public final RuleSetParser.meta_block_return meta_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1585:2: ( META LEFT_CURL (name= must_be_one[sar(\"description\",\"name\",\"author\")] (html_desc= HTML | string_desc= STRING ) | KEY what= must_be_one[sar(\"errorstack\",\"googleanalytics\",\"facebook\",\"twitter\",\"amazon\",\"kpds\",\"google\")] (key_value= STRING | LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL )+ | AUTHZ REQUIRE must_be[\"user\"] | LOGGING onoff= ( ON | OFF ) | USE ( (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) ) | ( MODULE modname= VAR ( ALIAS alias= VAR )? ) ) )* RIGHT_CURL )
            // RuleSet.g:1585:4: META LEFT_CURL (name= must_be_one[sar(\"description\",\"name\",\"author\")] (html_desc= HTML | string_desc= STRING ) | KEY what= must_be_one[sar(\"errorstack\",\"googleanalytics\",\"facebook\",\"twitter\",\"amazon\",\"kpds\",\"google\")] (key_value= STRING | LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL )+ | AUTHZ REQUIRE must_be[\"user\"] | LOGGING onoff= ( ON | OFF ) | USE ( (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) ) | ( MODULE modname= VAR ( ALIAS alias= VAR )? ) ) )* RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();

            META169=(Token)match(input,META,FOLLOW_META_in_meta_block3721); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            META169_tree = (Object)adaptor.create(META169);
            adaptor.addChild(root_0, META169_tree);
            }
            LEFT_CURL170=(Token)match(input,LEFT_CURL,FOLLOW_LEFT_CURL_in_meta_block3723); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            LEFT_CURL170_tree = (Object)adaptor.create(LEFT_CURL170);
            adaptor.addChild(root_0, LEFT_CURL170_tree);
            }
            // RuleSet.g:1586:2: (name= must_be_one[sar(\"description\",\"name\",\"author\")] (html_desc= HTML | string_desc= STRING ) | KEY what= must_be_one[sar(\"errorstack\",\"googleanalytics\",\"facebook\",\"twitter\",\"amazon\",\"kpds\",\"google\")] (key_value= STRING | LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL )+ | AUTHZ REQUIRE must_be[\"user\"] | LOGGING onoff= ( ON | OFF ) | USE ( (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) ) | ( MODULE modname= VAR ( ALIAS alias= VAR )? ) ) )*
            loop111:
            do {
                int alt111=6;
                switch ( input.LA(1) ) {
                ...
                switch (alt111) {
            	case 1 :
            	    // RuleSet.g:1586:5: name= must_be_one[sar(\"description\",\"name\",\"author\")] (html_desc= HTML | string_desc= STRING )
            	    {
            	    pushFollow(FOLLOW_must_be_one_in_meta_block3732);
            	    name=must_be_one(sar("description","name","author"));

            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, name.getTree());
            	    // RuleSet.g:1586:58: (html_desc= HTML | string_desc= STRING )
            	    int alt105=2;
            	    ...
            	    switch (alt105) {
            	        case 1 :
            	            // RuleSet.g:1586:59: html_desc= HTML
            	            {
            	            html_desc=(Token)match(input,HTML,FOLLOW_HTML_in_meta_block3738); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            	            ...
            	            break;
            	        case 2 :
            	            // RuleSet.g:1586:74: string_desc= STRING
            	            {
            	            string_desc=(Token)match(input,STRING,FOLLOW_STRING_in_meta_block3742); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            	    ...
            	    break;
            	case 2 :
            	    // RuleSet.g:1596:5: KEY what= must_be_one[sar(\"errorstack\",\"googleanalytics\",\"facebook\",\"twitter\",\"amazon\",\"kpds\",\"google\")] (key_value= STRING | LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL )+
            	    {
            	    KEY171=(Token)match(input,KEY,FOLLOW_KEY_in_meta_block3756); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    KEY171_tree = (Object)adaptor.create(KEY171);
            	    adaptor.addChild(root_0, KEY171_tree);
            	    }
            	    pushFollow(FOLLOW_must_be_one_in_meta_block3760);
            	    ...
            	    // RuleSet.g:1596:109: (key_value= STRING | LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL )+
            	    int cnt107=0;
            	    loop107:
            	    do {
            	        int alt107=3;
            	        ...
            	        switch (alt107) {
            	    	case 1 :
            	    	    // RuleSet.g:1596:110: key_value= STRING
            	    	    {
            	    	    key_value=(Token)match(input,STRING,FOLLOW_STRING_in_meta_block3766); if (state.failed) return retval;
            	    	    if ( state.backtracking==0 ) {
            	    	    ...
            	    	    break;
            	    	case 2 :
            	    	    // RuleSet.g:1597:6: LEFT_CURL ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* ) RIGHT_CURL
            	    	    {
            	    	    LEFT_CURL172=(Token)match(input,LEFT_CURL,FOLLOW_LEFT_CURL_in_meta_block3774); if (state.failed) return retval;
            	    	    if ( state.backtracking==0 ) {
            	    	    LEFT_CURL172_tree = (Object)adaptor.create(LEFT_CURL172);
            	    	    adaptor.addChild(root_0, LEFT_CURL172_tree);
            	    	    }
            	    	    // RuleSet.g:1597:16: ( name_value_pair[key_values] ( COMMA name_value_pair[key_values] )* )
            	    	    // RuleSet.g:1597:17: name_value_pair[key_values] ( COMMA name_value_pair[key_values] )*
            	    	    {
            	    	    pushFollow(FOLLOW_name_value_pair_in_meta_block3777);
            	    	    name_value_pair173=name_value_pair(key_values);

            	    	    state._fsp--;
            	    	    if (state.failed) return retval;
            	    	    if ( state.backtracking==0 ) adaptor.addChild(root_0, name_value_pair173.getTree());
            	    	    // RuleSet.g:1597:45: ( COMMA name_value_pair[key_values] )*
            	    	    loop106:
            	    	    do {
            	    	        int alt106=2;
            	    	        ...
            	    	        switch (alt106) {
            	    	    	case 1 :
            	    	    	    // RuleSet.g:1597:46: COMMA name_value_pair[key_values]
            	    	    	    {
            	    	    	    COMMA174=(Token)match(input,COMMA,FOLLOW_COMMA_in_meta_block3781); if (state.failed) return retval;
            	    	    	    if ( state.backtracking==0 ) {
            	    	    	    COMMA174_tree = (Object)adaptor.create(COMMA174);
            	    	    	    adaptor.addChild(root_0, COMMA174_tree);
            	    	    	    }
            	    	    	    pushFollow(FOLLOW_name_value_pair_in_meta_block3783);
            	    	    ...
            	    	    RIGHT_CURL176=(Token)match(input,RIGHT_CURL,FOLLOW_RIGHT_CURL_in_meta_block3789); if (state.failed) return retval;
            	    	    if ( state.backtracking==0 ) {
            	    ...
            	    break;
            	case 3 :
            	    // RuleSet.g:1604:4: AUTHZ REQUIRE must_be[\"user\"]
            	    {
            	    AUTHZ177=(Token)match(input,AUTHZ,FOLLOW_AUTHZ_in_meta_block3801); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    AUTHZ177_tree = (Object)adaptor.create(AUTHZ177);
            	    adaptor.addChild(root_0, AUTHZ177_tree);
            	    }
            	    REQUIRE178=(Token)match(input,REQUIRE,FOLLOW_REQUIRE_in_meta_block3803); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    REQUIRE178_tree = (Object)adaptor.create(REQUIRE178);
            	    adaptor.addChild(root_0, REQUIRE178_tree);
            	    }
            	    pushFollow(FOLLOW_must_be_in_meta_block3805);
            	    ...
            	    break;
            	case 4 :
            	    // RuleSet.g:1610:4: LOGGING onoff= ( ON | OFF )
            	    {
            	    LOGGING180=(Token)match(input,LOGGING,FOLLOW_LOGGING_in_meta_block3814); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    ...
            	    break;
            	case 5 :
            	    // RuleSet.g:1611:4: USE ( (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) ) | ( MODULE modname= VAR ( ALIAS alias= VAR )? ) )
            	    {
            	    USE181=(Token)match(input,USE,FOLLOW_USE_in_meta_block3829); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    USE181_tree = (Object)adaptor.create(USE181);
            	    adaptor.addChild(root_0, USE181_tree);
            	    }
            	    // RuleSet.g:1611:8: ( (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) ) | ( MODULE modname= VAR ( ALIAS alias= VAR )? ) )
            	    int alt110=2;
            	    int LA110_0 = input.LA(1);

            	    if ( (LA110_0==CSS||LA110_0==JAVASCRIPT) ) {
            	        alt110=1;
            	    }
            	    else if ( (LA110_0==MODULE) ) {
            	        alt110=2;
            	    }
            	    else {
            	        if (state.backtracking>0) {state.failed=true; return retval;}
            	    ...
            	    switch (alt110) {
            	        case 1 :
            	            // RuleSet.g:1611:10: (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) )
            	            {
            	            // RuleSet.g:1611:10: (rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR ) )
            	            // RuleSet.g:1611:11: rtype= ( CSS | JAVASCRIPT ) must_be[\"resource\"] (url= STRING | nicename= VAR )
            	            {
            	            ...
            	            switch (alt108) {
            	                case 1 :
            	                    // RuleSet.g:1611:55: url= STRING
            	                    {
            	                    url=(Token)match(input,STRING,FOLLOW_STRING_in_meta_block3848); if (state.failed) return retval;
            	                    if ( state.backtracking==0 ) {
            	                    ...
            	                    break;
            	                case 2 :
            	                    // RuleSet.g:1611:68: nicename= VAR
            	                    {
            	                    nicename=(Token)match(input,VAR,FOLLOW_VAR_in_meta_block3854); if (state.failed) return retval;
            	                    if ( state.backtracking==0 ) {
            	            ...
            	            break;
            	        case 2 :
            	            // RuleSet.g:1630:6: ( MODULE modname= VAR ( ALIAS alias= VAR )? )
            	            {
            	            // RuleSet.g:1630:6: ( MODULE modname= VAR ( ALIAS alias= VAR )? )
            	            // RuleSet.g:1630:7: MODULE modname= VAR ( ALIAS alias= VAR )?
            	            {
            	            MODULE183=(Token)match(input,MODULE,FOLLOW_MODULE_in_meta_block3869); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            	            MODULE183_tree = (Object)adaptor.create(MODULE183);
            	            adaptor.addChild(root_0, MODULE183_tree);
            	            }
            	            modname=(Token)match(input,VAR,FOLLOW_VAR_in_meta_block3874); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            	            modname_tree = (Object)adaptor.create(modname);
            	            adaptor.addChild(root_0, modname_tree);
            	            }
            	            // RuleSet.g:1630:27: ( ALIAS alias= VAR )?
            	            int alt109=2;
            	            ...
            	            switch (alt109) {
            	                case 1 :
            	                    // RuleSet.g:1630:28: ALIAS alias= VAR
            	                    {
            	                    ALIAS184=(Token)match(input,ALIAS,FOLLOW_ALIAS_in_meta_block3877); if (state.failed) return retval;
            	                    if ( state.backtracking==0 ) {
            	                    ALIAS184_tree = (Object)adaptor.create(ALIAS184);
            	                    adaptor.addChild(root_0, ALIAS184_tree);
            	                    }
            	                    alias=(Token)match(input,VAR,FOLLOW_VAR_in_meta_block3881); if (state.failed) return retval;
            	                    if ( state.backtracking==0 ) {
            ...
            RIGHT_CURL185=(Token)match(input,RIGHT_CURL,FOLLOW_RIGHT_CURL_in_meta_block3896); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // RuleSet.g:1645:1: dispatch_block : must_be[\"dispatch\"] LEFT_CURL ( must_be[\"domain\"] domain= STRING ( RIGHT_SMALL_ARROW rsid= STRING )? )* RIGHT_CURL ;
    public final RuleSetParser.dispatch_block_return dispatch_block() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1651:2: ( must_be[\"dispatch\"] LEFT_CURL ( must_be[\"domain\"] domain= STRING ( RIGHT_SMALL_ARROW rsid= STRING )? )* RIGHT_CURL )
            // RuleSet.g:1651:4: must_be[\"dispatch\"] LEFT_CURL ( must_be[\"domain\"] domain= STRING ( RIGHT_SMALL_ARROW rsid= STRING )? )* RIGHT_CURL
            {
            root_0 = (Object)adaptor.nil();

            pushFollow(FOLLOW_must_be_in_dispatch_block3927);
            must_be186=must_be("dispatch");

            state._fsp--;
            if (state.failed) return retval;
            if ( state.backtracking==0 ) adaptor.addChild(root_0, must_be186.getTree());
            LEFT_CURL187=(Token)match(input,LEFT_CURL,FOLLOW_LEFT_CURL_in_dispatch_block3931); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            LEFT_CURL187_tree = (Object)adaptor.create(LEFT_CURL187);
            adaptor.addChild(root_0, LEFT_CURL187_tree);
            }
            // RuleSet.g:1651:35: ( must_be[\"domain\"] domain= STRING ( RIGHT_SMALL_ARROW rsid= STRING )? )*
            loop113:
            do {
                int alt113=2;
                ...
                switch (alt113) {
            	case 1 :
            	    // RuleSet.g:1651:37: must_be[\"domain\"] domain= STRING ( RIGHT_SMALL_ARROW rsid= STRING )?
            	    {
            	    pushFollow(FOLLOW_must_be_in_dispatch_block3935);
            	    must_be188=must_be("domain");

            	    state._fsp--;
            	    if (state.failed) return retval;
            	    if ( state.backtracking==0 ) adaptor.addChild(root_0, must_be188.getTree());
            	    domain=(Token)match(input,STRING,FOLLOW_STRING_in_dispatch_block3940); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    domain_tree = (Object)adaptor.create(domain);
            	    adaptor.addChild(root_0, domain_tree);
            	    }
            	    // RuleSet.g:1651:69: ( RIGHT_SMALL_ARROW rsid= STRING )?
            	    int alt112=2;
            	    int LA112_0 = input.LA(1);

            	    if ( (LA112_0==RIGHT_SMALL_ARROW) ) {
            	        alt112=1;
            	    }
            	    switch (alt112) {
            	        case 1 :
            	            // RuleSet.g:1651:70: RIGHT_SMALL_ARROW rsid= STRING
            	            {
            	            RIGHT_SMALL_ARROW189=(Token)match(input,RIGHT_SMALL_ARROW,FOLLOW_RIGHT_SMALL_ARROW_in_dispatch_block3943); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            	            RIGHT_SMALL_ARROW189_tree = (Object)adaptor.create(RIGHT_SMALL_ARROW189);
            	            adaptor.addChild(root_0, RIGHT_SMALL_ARROW189_tree);
            	            }
            	            rsid=(Token)match(input,STRING,FOLLOW_STRING_in_dispatch_block3947); if (state.failed) return retval;
            	            if ( state.backtracking==0 ) {
            ...
            RIGHT_CURL190=(Token)match(input,RIGHT_CURL,FOLLOW_RIGHT_CURL_in_dispatch_block3958); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    // RuleSet.g:1674:1: name_value_pair[HashMap key_values] : k= STRING COLON (v= INT | v= FLOAT | v= STRING ) ;
    public final RuleSetParser.name_value_pair_return name_value_pair(HashMap key_values) throws RecognitionException {
        ...
        try {
            // RuleSet.g:1678:2: (k= STRING COLON (v= INT | v= FLOAT | v= STRING ) )
            // RuleSet.g:1678:4: k= STRING COLON (v= INT | v= FLOAT | v= STRING )
            {
            root_0 = (Object)adaptor.nil();

            k=(Token)match(input,STRING,FOLLOW_STRING_in_name_value_pair3981); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            k_tree = (Object)adaptor.create(k);
            adaptor.addChild(root_0, k_tree);
            }
            COLON191=(Token)match(input,COLON,FOLLOW_COLON_in_name_value_pair3983); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            COLON191_tree = (Object)adaptor.create(COLON191);
            adaptor.addChild(root_0, COLON191_tree);
            }
            // RuleSet.g:1678:19: (v= INT | v= FLOAT | v= STRING )
            int alt114=3;
            switch ( input.LA(1) ) {
            case INT:
                {
            ...
            switch (alt114) {
                case 1 :
                    // RuleSet.g:1679:3: v= INT
                    {
                    v=(Token)match(input,INT,FOLLOW_INT_in_name_value_pair3991); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    v_tree = (Object)adaptor.create(v);
                    adaptor.addChild(root_0, v_tree);
                    }
                    ...
                    break;
                case 2 :
                    // RuleSet.g:1680:5: v= FLOAT
                    {
                    v=(Token)match(input,FLOAT,FOLLOW_FLOAT_in_name_value_pair4002); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    v_tree = (Object)adaptor.create(v);
                    adaptor.addChild(root_0, v_tree);
                    }
                    ...
                    break;
                case 3 :
                    // RuleSet.g:1681:5: v= STRING
                    {
                    v=(Token)match(input,STRING,FOLLOW_STRING_in_name_value_pair4013); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    v_tree = (Object)adaptor.create(v);
                    adaptor.addChild(root_0, v_tree);
                    }
    ...
    // $ANTLR start "regex"
    // RuleSet.g:1691:1: regex returns [HashMap result] : rx= REX ;
    public final RuleSetParser.regex_return regex() throws RecognitionException {
        ...
        try {
            // RuleSet.g:1695:6: (rx= REX )
            // RuleSet.g:1696:8: rx= REX
            {
            root_0 = (Object)adaptor.nil();

            rx=(Token)match(input,REX,FOLLOW_REX_in_regex4059); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            rx_tree = (Object)adaptor.create(rx);
            adaptor.addChild(root_0, rx_tree);
            }
    ...
    public final void synpred88_RuleSet_fragment() throws RecognitionException {   
        // RuleSet.g:925:2: ( custom_event )
        // RuleSet.g:925:3: custom_event
        {
    ...
    public final void synpred140_RuleSet_fragment() throws RecognitionException {   
        ...
        pushFollow(FOLLOW_unary_expr_in_synpred140_RuleSet2561);
        me2=unary_expr();
    ...
    public final void synpred147_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1231:106: t= timeframe
        {
        pushFollow(FOLLOW_timeframe_in_synpred147_RuleSet2651);
        t=timeframe();
    ...
    public final void synpred148_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1231:4: SEEN rx= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) (t= timeframe )?
        {
        match(input,SEEN,FOLLOW_SEEN_in_synpred148_RuleSet2618); if (state.failed) return ;
        rx=(Token)match(input,STRING,FOLLOW_STRING_in_synpred148_RuleSet2622); if (state.failed) return ;
        pushFollow(FOLLOW_must_be_in_synpred148_RuleSet2624);
        must_be("in");

        state._fsp--;
        if (state.failed) return ;
        vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_synpred148_RuleSet2629); if (state.failed) return ;
        match(input,COLON,FOLLOW_COLON_in_synpred148_RuleSet2631); if (state.failed) return ;
        v=(Token)input.LT(1);
        if ( input.LA(1)==VAR||(input.LA(1)>=OTHER_OPERATORS && input.LA(1)<=MATCH)||input.LA(1)==VAR_DOMAIN ) {
            input.consume();
            state.errorRecovery=false;state.failed=false;
        ...
        switch (alt135) {
            case 1 :
                // RuleSet.g:0:0: t= timeframe
                {
                pushFollow(FOLLOW_timeframe_in_synpred148_RuleSet2651);
                t=timeframe();
    ...
    public final void synpred154_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1242:4: SEEN rx_1= STRING op= must_be_one[sar(\"before\",\"after\")] rx_2= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
        {
        match(input,SEEN,FOLLOW_SEEN_in_synpred154_RuleSet2659); if (state.failed) return ;
        rx_1=(Token)match(input,STRING,FOLLOW_STRING_in_synpred154_RuleSet2663); if (state.failed) return ;
        pushFollow(FOLLOW_must_be_one_in_synpred154_RuleSet2667);
        op=must_be_one(sar("before","after"));

        state._fsp--;
        if (state.failed) return ;
        rx_2=(Token)match(input,STRING,FOLLOW_STRING_in_synpred154_RuleSet2672); if (state.failed) return ;
        pushFollow(FOLLOW_must_be_in_synpred154_RuleSet2675);
        must_be("in");

        state._fsp--;
        if (state.failed) return ;
        vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_synpred154_RuleSet2680); if (state.failed) return ;
        match(input,COLON,FOLLOW_COLON_in_synpred154_RuleSet2682); if (state.failed) return ;
        v=(Token)input.LT(1);
        if ( input.LA(1)==VAR||(input.LA(1)>=OTHER_OPERATORS && input.LA(1)<=MATCH)||input.LA(1)==VAR_DOMAIN ) {
            input.consume();
            state.errorRecovery=false;state.failed=false;
    ...
    public final void synpred161_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1252:4: vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) pop= ( PREDOP | LIKE ) e= expr t= timeframe
        {
        vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_synpred161_RuleSet2707); if (state.failed) return ;
        match(input,COLON,FOLLOW_COLON_in_synpred161_RuleSet2709); if (state.failed) return ;
        v=(Token)input.LT(1);
        if ( input.LA(1)==VAR||(input.LA(1)>=OTHER_OPERATORS && input.LA(1)<=MATCH)||input.LA(1)==VAR_DOMAIN ) {
            input.consume();
            state.errorRecovery=false;state.failed=false;
        ...
        pushFollow(FOLLOW_expr_in_synpred161_RuleSet2737);
        e=expr();

        state._fsp--;
        if (state.failed) return ;
        pushFollow(FOLLOW_timeframe_in_synpred161_RuleSet2741);
        t=timeframe();
    ...
    public final void synpred167_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1264:4: vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) t= timeframe
        {
        vd=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_synpred167_RuleSet2751); if (state.failed) return ;
        match(input,COLON,FOLLOW_COLON_in_synpred167_RuleSet2753); if (state.failed) return ;
        v=(Token)input.LT(1);
        if ( input.LA(1)==VAR||(input.LA(1)>=OTHER_OPERATORS && input.LA(1)<=MATCH)||input.LA(1)==VAR_DOMAIN ) {
            input.consume();
            state.errorRecovery=false;state.failed=false;
        ...
        pushFollow(FOLLOW_timeframe_in_synpred167_RuleSet2773);
        t=timeframe();
    ...
    public final void synpred168_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1279:4: roe= regex
        {
        pushFollow(FOLLOW_regex_in_synpred168_RuleSet2782);
        roe=regex();
    ...
    public final void synpred184_RuleSet_fragment() throws RecognitionException {   
        ...
        match(input,LEFT_BRACKET,FOLLOW_LEFT_BRACKET_in_synpred184_RuleSet3090); if (state.failed) return ;
        pushFollow(FOLLOW_expr_in_synpred184_RuleSet3094);
        e=expr();

        state._fsp--;
        if (state.failed) return ;
        match(input,RIGHT_BRACKET,FOLLOW_RIGHT_BRACKET_in_synpred184_RuleSet3096); if (state.failed) return ;
    ...
    public final void synpred190_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1402:9: d= VAR_DOMAIN COLON vv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN )
        {
        d=(Token)match(input,VAR_DOMAIN,FOLLOW_VAR_DOMAIN_in_synpred190_RuleSet3111); if (state.failed) return ;
        match(input,COLON,FOLLOW_COLON_in_synpred190_RuleSet3113); if (state.failed) return ;
        vv=(Token)input.LT(1);
        if ( input.LA(1)==VAR||(input.LA(1)>=OTHER_OPERATORS && input.LA(1)<=MATCH)||input.LA(1)==VAR_DOMAIN ) {
            input.consume();
            state.errorRecovery=false;state.failed=false;
    ...
    public final void synpred210_RuleSet_fragment() throws RecognitionException {   
        ...
        // RuleSet.g:1430:9: n= namespace p= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN
        {
        pushFollow(FOLLOW_namespace_in_synpred210_RuleSet3216);
        n=namespace();
        ...
        match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_synpred210_RuleSet3234); if (state.failed) return ;
        // RuleSet.g:1430:86: (e= expr ( COMMA e= expr )* )?
        int alt141=2;
        int LA141_0 = input.LA(1);

        if ( (LA141_0==LEFT_CURL||(LA141_0>=VAR && LA141_0<=MATCH)||(LA141_0>=STRING && LA141_0<=VAR_DOMAIN)||LA141_0==LEFT_PAREN||LA141_0==NOT||LA141_0==FUNCTION||(LA141_0>=REX && LA141_0<=SEEN)||(LA141_0>=FLOAT && LA141_0<=LEFT_BRACKET)||(LA141_0>=CURRENT && LA141_0<=HISTORY)) ) {
            alt141=1;
        }
        switch (alt141) {
            case 1 :
                // RuleSet.g:1430:87: e= expr ( COMMA e= expr )*
                {
                pushFollow(FOLLOW_expr_in_synpred210_RuleSet3239);
                e=expr();
                ...
                do {
                	...
                	case 1 :
                	    // RuleSet.g:1430:123: COMMA e= expr
                	    {
                	    match(input,COMMA,FOLLOW_COMMA_in_synpred210_RuleSet3245); if (state.failed) return ;
                	    pushFollow(FOLLOW_expr_in_synpred210_RuleSet3249);
                	    e=expr();
        ...
        match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_synpred210_RuleSet3258); if (state.failed) return ;
    ...
    public final void synpred218_RuleSet_fragment() throws RecognitionException {   
        ...
        match(input,LEFT_PAREN,FOLLOW_LEFT_PAREN_in_synpred218_RuleSet3287); if (state.failed) return ;
        // RuleSet.g:1438:74: (e= expr ( COMMA e= expr )* )?
        int alt144=2;
        int LA144_0 = input.LA(1);

        if ( (LA144_0==LEFT_CURL||(LA144_0>=VAR && LA144_0<=MATCH)||(LA144_0>=STRING && LA144_0<=VAR_DOMAIN)||LA144_0==LEFT_PAREN||LA144_0==NOT||LA144_0==FUNCTION||(LA144_0>=REX && LA144_0<=SEEN)||(LA144_0>=FLOAT && LA144_0<=LEFT_BRACKET)||(LA144_0>=CURRENT && LA144_0<=HISTORY)) ) {
            alt144=1;
        }
        switch (alt144) {
            case 1 :
                // RuleSet.g:1438:75: e= expr ( COMMA e= expr )*
                {
                pushFollow(FOLLOW_expr_in_synpred218_RuleSet3292);
                e=expr();
                ...
                do {
                	...
                	case 1 :
                	    // RuleSet.g:1438:111: COMMA e= expr
                	    {
                	    match(input,COMMA,FOLLOW_COMMA_in_synpred218_RuleSet3297); if (state.failed) return ;
                	    pushFollow(FOLLOW_expr_in_synpred218_RuleSet3301);
                	    e=expr();
        ...
        match(input,RIGHT_PAREN,FOLLOW_RIGHT_PAREN_in_synpred218_RuleSet3310); if (state.failed) return ;
    ...
    static final String DFA20_minS =
        "\1\7\1\5\1\uffff\1\6\1\uffff\1\25\2\uffff\1\7\1\0";
    static final String DFA20_maxS =
        "\1\30\1\102\1\uffff\1\77\1\uffff\1\77\2\uffff\1\24\1\0";
    static final String DFA20_acceptS =
        "\2\uffff\1\1\1\uffff\1\3\1\uffff\1\4\1\2\2\uffff";
    static final String DFA20_specialS =
        "\11\uffff\1\0}>";
    static final String[] DFA20_transitionS = {
            "\1\1\14\uffff\1\2\2\uffff\2\2",
            "\1\4\1\6\1\3\5\4\2\6\4\uffff\1\4\1\5\11\uffff\1\4\12\uffff"+
            "\1\4\10\uffff\1\4\6\uffff\2\4\1\uffff\4\4\1\uffff\2\4",
            "",
            "\1\4\1\7\2\uffff\1\4\2\uffff\2\4\6\uffff\1\4\7\uffff\2\4\25"+
            "\uffff\6\4\1\uffff\1\4\3\uffff\1\4",
            "",
            "\1\10\10\uffff\1\4\40\uffff\1\4",
            "",
    ...
    class DFA20 extends DFA {
        ...
        public String getDescription() {
            return "347:5: (pe= persistent_expr | rs= raise_statement | l= log_statement | las= must_be[\"last\"] )";
        }
    ...
    class DFA57 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 758:16: (tb= must_be_one[sar(\"then\",\"before\")] eor2= event_or )*";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    class DFA68 extends DFA {
        ...
        public String getDescription() {
            return "920:1: event_prim returns [HashMap result] : ( ( custom_event )=>ce= custom_event | (web= WEB )? PAGEVIEW (spat= STRING | rpat= regex ) (set= setting )? | (web= WEB )? opt= must_be_one[sar(\"submit\",\"click\",\"dblclick\",\"change\",\"update\")] elem= STRING (on= on_expr )? (set= setting )? | '(' evt= event_seq ')' );";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
            switch ( s ) {
                    case 0 : 
                        ...
                        input.rewind();
                        s = -1;
                        if ( (LA68_5==VAR) && (synpred88_RuleSet())) {s = 8;}
    ...
    class DFA85 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 1176:17: (op= ( PREDOP | LIKE ) me2= add_expr )*";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    static final String[] DFA86_transitionS = {
            ...
            "\5\1\2\44\1\30\1\1\1\uffff\11\1\1\uffff\1\1",
            "",
            "",
            "",
            "",
    ...
    class DFA86 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 1199:20: (op= ( ADD_OP | MULT_OP | REX ) me2= unary_expr )*";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    class DFA88 extends DFA {
        ...
        public String getDescription() {
            return "1218:1: unary_expr returns [Object result] options {backtrack=true; } : ( NOT ue= unary_expr | SEEN rx= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) (t= timeframe )? | SEEN rx_1= STRING op= must_be_one[sar(\"before\",\"after\")] rx_2= STRING must_be[\"in\"] vd= VAR_DOMAIN ':' v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) pop= ( PREDOP | LIKE ) e= expr t= timeframe | vd= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) t= timeframe | roe= regex | oe= operator_expr );";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    class DFA101 extends DFA {
        ...
        public String getDescription() {
            return "1359:1: factor returns [Object result] options {backtrack=true; } : (iv= INT | sv= STRING | fv= FLOAT | bv= ( TRUE | FALSE ) | bv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_BRACKET e= expr RIGHT_BRACKET | d= VAR_DOMAIN COLON vv= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | CURRENT d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | HISTORY e= expr d= VAR_DOMAIN COLON v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) | n= namespace p= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN | v= ( VAR | OTHER_OPERATORS | LIKE | REPLACE | MATCH | VAR_DOMAIN ) LEFT_PAREN (e= expr ( COMMA e= expr )* )? RIGHT_PAREN | LEFT_BRACKET (e= expr ( COMMA e2= expr )* )? RIGHT_BRACKET | LEFT_CURL (h1= hash_line ( COMMA h2= hash_line )* )? RIGHT_CURL | LEFT_PAREN e= expr RIGHT_PAREN | v= ( VAR | OTHER_OPERATORS | REPLACE | MATCH ) | reg= regex );";
        }
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            TokenStream input = (TokenStream)_input;
        	int _s = s;
    ...
    public static final BitSet FOLLOW_unary_expr_in_add_expr2545 = new BitSet(new long[]{0x0380000000000002L});
    public static final BitSet FOLLOW_set_in_add_expr2551 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_unary_expr_in_add_expr2561 = new BitSet(new long[]{0x0380000000000002L});
    public static final BitSet FOLLOW_NOT_in_unary_expr2605 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_unary_expr_in_unary_expr2609 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEEN_in_unary_expr2618 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_unary_expr2622 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_unary_expr2624 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_unary_expr2629 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_unary_expr2631 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_unary_expr2635 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_unary_expr2651 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEEN_in_unary_expr2659 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_unary_expr2663 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_one_in_unary_expr2667 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_unary_expr2672 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_unary_expr2675 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_unary_expr2680 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_unary_expr2682 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_unary_expr2686 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_unary_expr2707 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_unary_expr2709 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_unary_expr2713 = new BitSet(new long[]{0x0040000000000400L});
    public static final BitSet FOLLOW_set_in_unary_expr2729 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_unary_expr2737 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_unary_expr2741 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_unary_expr2751 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_unary_expr2753 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_unary_expr2757 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_unary_expr2773 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_regex_in_unary_expr2782 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_operator_expr_in_unary_expr2791 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_factor_in_operator_expr2820 = new BitSet(new long[]{0x0800000000000002L});
    public static final BitSet FOLLOW_operator_in_operator_expr2826 = new BitSet(new long[]{0x0800000000000002L});
    public static final BitSet FOLLOW_DOT_in_operator2853 = new BitSet(new long[]{0x0000000000001A00L});
    public static final BitSet FOLLOW_OTHER_OPERATORS_in_operator2859 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_operator2861 = new BitSet(new long[]{0xF604020140181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_operator2866 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_COMMA_in_operator2871 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_operator2875 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_operator2884 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_MATCH_in_operator2908 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_operator2910 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_operator2914 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_operator2919 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REPLACE_in_operator2944 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_operator2946 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_operator2950 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_COMMA_in_operator2954 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_operator2958 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_operator2961 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INT_in_factor3001 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_factor3016 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FLOAT_in_factor3036 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_factor3056 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_factor3076 = new BitSet(new long[]{0x8000000000000000L});
    public static final BitSet FOLLOW_LEFT_BRACKET_in_factor3090 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3094 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_RIGHT_BRACKET_in_factor3096 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_factor3111 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_factor3113 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_factor3117 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CURRENT_in_factor3141 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_factor3145 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_factor3147 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_factor3151 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_HISTORY_in_factor3176 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3180 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_factor3184 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_factor3186 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_factor3190 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_namespace_in_factor3216 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_factor3220 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_factor3234 = new BitSet(new long[]{0xF604020140181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3239 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_COMMA_in_factor3245 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3249 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_factor3258 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_factor3273 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_factor3287 = new BitSet(new long[]{0xF604020140181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3292 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_COMMA_in_factor3297 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3301 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_factor3310 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFT_BRACKET_in_factor3322 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000007L});
    public static final BitSet FOLLOW_expr_in_factor3327 = new BitSet(new long[]{0x0000000080000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_COMMA_in_factor3332 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3336 = new BitSet(new long[]{0x0000000080000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_RIGHT_BRACKET_in_factor3344 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFT_CURL_in_factor3356 = new BitSet(new long[]{0x0000000000080040L});
    public static final BitSet FOLLOW_hash_line_in_factor3361 = new BitSet(new long[]{0x0000000080000040L});
    public static final BitSet FOLLOW_COMMA_in_factor3366 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_hash_line_in_factor3370 = new BitSet(new long[]{0x0000000080000040L});
    public static final BitSet FOLLOW_RIGHT_CURL_in_factor3379 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_factor3391 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_factor3395 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_factor3398 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_factor3417 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_regex_in_factor3441 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_namespace3474 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_namespace3488 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WITHIN_in_timeframe3510 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_timeframe3514 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_period_in_timeframe3518 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_hash_line3545 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_hash_line3547 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_hash_line3551 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CSS_in_css_emit3569 = new BitSet(new long[]{0x0002000000080000L});
    public static final BitSet FOLLOW_HTML_in_css_emit3575 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_css_emit3583 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_must_be_one_in_period3603 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CACHABLE_in_cachable3637 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_FOR_in_cachable3640 = new BitSet(new long[]{0x0000000000000100L});
    public static final BitSet FOLLOW_INT_in_cachable3644 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_period_in_cachable3648 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EMIT_in_emit_block3670 = new BitSet(new long[]{0x0002000400080000L});
    public static final BitSet FOLLOW_HTML_in_emit_block3676 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_emit_block3684 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_JS_in_emit_block3692 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_META_in_meta_block3721 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_LEFT_CURL_in_meta_block3723 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_must_be_one_in_meta_block3732 = new BitSet(new long[]{0x0002000000080000L});
    public static final BitSet FOLLOW_HTML_in_meta_block3738 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_STRING_in_meta_block3742 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_KEY_in_meta_block3756 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_one_in_meta_block3760 = new BitSet(new long[]{0x0000000000080020L});
    public static final BitSet FOLLOW_STRING_in_meta_block3766 = new BitSet(new long[]{0x00000000000800E0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_LEFT_CURL_in_meta_block3774 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_name_value_pair_in_meta_block3777 = new BitSet(new long[]{0x0000000080000040L});
    public static final BitSet FOLLOW_COMMA_in_meta_block3781 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_name_value_pair_in_meta_block3783 = new BitSet(new long[]{0x0000000080000040L});
    public static final BitSet FOLLOW_RIGHT_CURL_in_meta_block3789 = new BitSet(new long[]{0x00000000000800E0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_AUTHZ_in_meta_block3801 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_REQUIRE_in_meta_block3803 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_meta_block3805 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_LOGGING_in_meta_block3814 = new BitSet(new long[]{0x0000200000000000L,0x0000000000001000L});
    public static final BitSet FOLLOW_set_in_meta_block3818 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_USE_in_meta_block3829 = new BitSet(new long[]{0x0000000000000000L,0x000000000000C010L});
    public static final BitSet FOLLOW_set_in_meta_block3836 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_meta_block3842 = new BitSet(new long[]{0x0000000000080080L});
    public static final BitSet FOLLOW_STRING_in_meta_block3848 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_VAR_in_meta_block3854 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_MODULE_in_meta_block3869 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_VAR_in_meta_block3874 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000012B00L});
    public static final BitSet FOLLOW_ALIAS_in_meta_block3877 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_VAR_in_meta_block3881 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000002B00L});
    public static final BitSet FOLLOW_RIGHT_CURL_in_meta_block3896 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_must_be_in_dispatch_block3927 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_LEFT_CURL_in_dispatch_block3931 = new BitSet(new long[]{0x00000000000000C0L});
    public static final BitSet FOLLOW_must_be_in_dispatch_block3935 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_dispatch_block3940 = new BitSet(new long[]{0x00000000000000C0L,0x0000000000020000L});
    public static final BitSet FOLLOW_RIGHT_SMALL_ARROW_in_dispatch_block3943 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_dispatch_block3947 = new BitSet(new long[]{0x00000000000000C0L});
    public static final BitSet FOLLOW_RIGHT_CURL_in_dispatch_block3958 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_name_value_pair3981 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_name_value_pair3983 = new BitSet(new long[]{0x1000000000080100L});
    public static final BitSet FOLLOW_INT_in_name_value_pair3991 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FLOAT_in_name_value_pair4002 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_name_value_pair4013 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REX_in_regex4059 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_set_in_synpred140_RuleSet2551 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_unary_expr_in_synpred140_RuleSet2561 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_timeframe_in_synpred147_RuleSet2651 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEEN_in_synpred148_RuleSet2618 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_synpred148_RuleSet2622 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_synpred148_RuleSet2624 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_synpred148_RuleSet2629 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_synpred148_RuleSet2631 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred148_RuleSet2635 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_synpred148_RuleSet2651 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SEEN_in_synpred154_RuleSet2659 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_synpred154_RuleSet2663 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_one_in_synpred154_RuleSet2667 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_STRING_in_synpred154_RuleSet2672 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_must_be_in_synpred154_RuleSet2675 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_synpred154_RuleSet2680 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_synpred154_RuleSet2682 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred154_RuleSet2686 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_synpred161_RuleSet2707 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_synpred161_RuleSet2709 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred161_RuleSet2713 = new BitSet(new long[]{0x0040000000000400L});
    public static final BitSet FOLLOW_set_in_synpred161_RuleSet2729 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred161_RuleSet2737 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_synpred161_RuleSet2741 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_synpred167_RuleSet2751 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_synpred167_RuleSet2753 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred167_RuleSet2757 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_timeframe_in_synpred167_RuleSet2773 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_regex_in_synpred168_RuleSet2782 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_synpred184_RuleSet3076 = new BitSet(new long[]{0x8000000000000000L});
    public static final BitSet FOLLOW_LEFT_BRACKET_in_synpred184_RuleSet3090 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred184_RuleSet3094 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_RIGHT_BRACKET_in_synpred184_RuleSet3096 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_VAR_DOMAIN_in_synpred190_RuleSet3111 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_COLON_in_synpred190_RuleSet3113 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred190_RuleSet3117 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_namespace_in_synpred210_RuleSet3216 = new BitSet(new long[]{0x0000000000101E80L});
    public static final BitSet FOLLOW_set_in_synpred210_RuleSet3220 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_synpred210_RuleSet3234 = new BitSet(new long[]{0xF604020140181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred210_RuleSet3239 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_COMMA_in_synpred210_RuleSet3245 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred210_RuleSet3249 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_synpred210_RuleSet3258 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_synpred218_RuleSet3273 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_LEFT_PAREN_in_synpred218_RuleSet3287 = new BitSet(new long[]{0xF604020140181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred218_RuleSet3292 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_COMMA_in_synpred218_RuleSet3297 = new BitSet(new long[]{0xF604020040181FA0L,0x0000000000000006L});
    public static final BitSet FOLLOW_expr_in_synpred218_RuleSet3301 = new BitSet(new long[]{0x0000000180000000L});
    public static final BitSet FOLLOW_RIGHT_PAREN_in_synpred218_RuleSet3310 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_synpred229_RuleSet3417 = new BitSet(new long[]{0x0000000000000002L});
