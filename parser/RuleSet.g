...
@init {
	...
	: me1=conjunction (op=OR me2=conjunction{
		found_op = true;
		if(result.isEmpty())
		{
...
@init {
	...
	: me1=equality_expr (op=AND me2=equality_expr {
		found_op = true;
		if(result.isEmpty())
		{
			 add_to_expression(result,"pred",$op.text,$me1.result);
...
@init {
	...
	: iv=INT { 
      ...
      | n=namespace p=VAR LEFT_PAREN (e=expr {
            exprs2.add($e.result);
      	}
      	','?)* RIGHT_PAREN  {
	      	HashMap tmp = new HashMap();
