{
   ...
   "rules": [
      ...
      },
      {
         ...
         "emit": "\nif(window.OPTINI_WatchSet){ } else {    \tKOBJ.watchDOM(\"#rso\",function(){            var app = KOBJ.get_application(\"a679x1\");            app.reload();     \t\twindow.OPTINI_WatchSet = true;    \t});    }                ",
         "foreach": [],
         "name": "facebook",
         "pagetype": {"event_expr": {
            "legacy": 1,
      ...
      },
      {
         "actions": [{"action": {
            "args": [
               {
                  "type": "str",
                  "val": "font[size=-1]:first,#footer_about_igoogle_link,#footer"
               },
               {
                  "type": "var",
                  "val": "content"
