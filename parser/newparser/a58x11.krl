{
   "dispatch": [
      ...
      {"domain": "14thstreetchiropractic.com"},
      {"domain": "7stages.org"},
      {"domain": "actors-express.com"},
      {"domain": "ipst.gatech.edu/amp"},
      {"domain": "apexmuseum.org"},
      {"domain": "theartoftouchmassage.com"},
      {"domain": "artstation.org"},
      {"domain": "arts.emory.edu"},
      {"domain": "atlantaballet.com"},
      {"domain": "atlantabotanicalgarden.org"},
      {"domain": "thecontemporary.org"},
      {"domain": "www.atlantacycling.com"},
      {"domain": "www.atlantacyclorama.org"},
      {"domain": "agmchorus.org"},
      {"domain": "atlantahistorycenter.com"},
      {"domain": "atlantalyrictheatre.com"},
      {"domain": "atlantaopera.org"},
      {"domain": "atlantasymphony.org"},
      {"domain": "auroratheatre.com"},
      {"domain": "callanwolde.org"},
      {"domain": "puppet.org"},
      {"domain": "chopinatlanta.org"},
      {"domain": "citysegwaytours.com/atlanta"},
      {"domain": "kennesaw.edu/arts"},
      {"domain": "dekalbymphony.com"},
      {"domain": "fernbankmuseum.org"},
      {"domain": "gashakespeare.org"},
      {"domain": "habershamgardens.com"},
      {"domain": "high.org"},
      {"domain": "hodgearmynavy.com"},
      {"domain": "horizontheatre.com"},
      {"domain": "carlos.emory.edu"},
      {"domain": "museumofdesign.org"},
      {"domain": "newbalanceatlanta.com"},
      {"domain": "www.oglethorpe.edu"},
      {"domain": "orchestraatlanta.org"},
      {"domain": "oursongatlanta.com"},
      {"domain": "pizzeriaventi-atlanta.com"},
      {"domain": "rialtocenter.org"},
      {"domain": "risesushilounge.com"},
      {"domain": "shakespearetavern.com"},
      {"domain": "silkrestaurant.com"},
      {"domain": "skateescape.com"},
      {"domain": "spiveyhall.org"},
      {"domain": "pentable.com"},
      {"domain": "tindrumcafe.net"},
      {"domain": "urbangroundscoffee.com"},
      {"domain": "villagecafesmyrna.com"}
   ],
   "global": [
      {
   ...
   "meta": {
      "description": "\nPBA (aka WABE) Production Reminder \r\n\n",
      "logging": "off",
      "name": "PBA Production"
   },
   "rules": [
            ...
            "modifiers": [
               {
                  ...
                  "value": {
                     "type": "str",
                     "val": "http://service.azigo.com/remindmeac/fetch?callback=?&jsonData=true&source=pba"
                  }
               },
               {
                  "name": "outer_div_css",
