{
   ...
   "global": [],
   "meta": {
      "description": "\nRules used for the deployment of pre-canned KRL Templates   \n",
      "logging": "off",
      "name": "VuTemplates"
   },
   "rules": [
      ...
      },
      {
         ...
         "emit": "\nemit<<        if(window.OPTINI_WatchSet){ } else {    \tKOBJ.watchDOM(\"#rso\",function(){            var app = KOBJ.get_application(\"a99x7\");            app.reload();     \t\twindow.OPTINI_WatchSet = true;    \t});    }                ",
         "foreach": [],
