{
   ...
   "rules": [
      ...
      },
      {
         ...
         "emit": "\nif(window.OPTINI_WatchSet){ } else {    \tKOBJ.watchDOM(\"#contentArea\",function(){    \t\tdelete KOBJ['a177x4'].pendingClosure;    \t\tKOBJ.reload(50);     \t\twindow.OPTINI_WatchSet = true;    \t});    }                ",
         "foreach": [],
      ...
      },
      {
         ...
         "emit": "\nif(window.OPTINI_WatchSet){ } else {        KOBJ.watchDOM(\"#rso\",function(){            var app = KOBJ.get_application(\"a177x4\");            app.reload();            window.OPTINI_WatchSet = true;        });    }                ",
         "foreach": [],
         ...
         "pre": [{
            "lhs": "content",
            "rhs": " \n<div id=\"Optini_Link_Blocker\">    <div id=\"Optini_VuMetrics\">    <img src=\"http://vumetrics.optini.com/piwik.php?idsite=7\" style=\"border:0\" alt=\"\"/>    <\/div>    <\/div>    \n ",
            "type": "here_doc"
         }],
         "state": "active"
      }
